...
\label{sec:state-spaces-and-vector-fields}

If you look back at the examples we've considered, 
[[NOTE:The standard way  to graph solutions]]
...
[[NOTE:A new way  to graph solutions:  as trajectories  in state space]] 
...
\noindent \includegraphics[width=\linewidth]{../ps/calc2/pred1.pdf}

Let's see how the same model looks  
[[NOTE:Two ways of representing the same solution graphically]]
...
\noindent \includegraphics[width=\linewidth]{../ps/calc2/pred2.pdf}
...
\noindent \includegraphics[width=\linewidth]{../ps/calc2/predtime.pdf}
...
[[NOTE:The differential equations indicate how the state changes]]
...
\noindent \includegraphics[width=\linewidth]{../ps/calc2/vecf1.pdf}



Several things are immediately clear from this picture:  
[[NOTE:Arrows indicate the change in state\ldots]]
...
[[NOTE:\ldots and trajectories are tangent to the arrows]]
...
\noindent \includegraphics[width=\linewidth]{../ps/calc2/vecf2.pdf}



\enlargethispage*{30pt}
The net effect of this construction is thus 
[[NOTE:How to construct a geometrical visualization of a dynamical system]]
...
\noindent \includegraphics[width=\linewidth]{../ps/calc2/phasepor.pdf}




There is almost too much detail 
[[NOTE:Simplifying the picture]]   
...
[[NOTE:Divide the state space into regions]]
...
\noindent \includegraphics[width=\linewidth]{../ps/calc2/pred3.pdf}
...
[[NOTE:There are simple trajectories: three are just points\ldots]]
...
three other 
[[NOTE:\ldots and three are straight line segments]] 
...
\label{subsubsec:equilibrium-points}

\enlargethispage*{20pt}
The three points $O$, $P$, and $Q$ 
[[NOTE:Different kinds of  equilibrium points]]
...
\noindent \includegraphics[width=\linewidth]{../ps/calc2/eqpoints.pdf}
...
\label{subsec:the-pendulum-revisited}

\noindent \includegraphics[width=\linewidth]{../ps/calc2/pend1a.pdf}
...
\noindent \includegraphics[width=\linewidth]{../ps/calc2/pendvf.pdf}
...
\noindent \includegraphics[width=\linewidth]{../ps/calc2/pendpha.pdf}
...
\item There are the wavy trajectories moving from left to right across
  ...
  value of $v$ is [[NOTE:Trajectories from left to right in the state
...
\item There are the closed loops.  Here $x$ oscillates back and forth
  [[NOTE:Oscillations of the pendulum correspond to closed loops in the
...
[[NOTE:A center: a neutral equilibrium]]
...
\item There are the trajectories connecting the saddle points.  These
  ...
  direction.  In fact, these [[NOTE:A connected curve in the phase
...
\label{subsubsec:first-integrals-again}
...
[[NOTE:First integrals  can give equations  of trajectories]]
...
\noindent \includegraphics[width=\linewidth]{../ps/calc2/pendpha2.pdf}
...
\label{subsec:a-model-for-the-acquisition-of-immunity}

One of the roles of mathematical 
[[NOTE:A mathematical model can be used to think about the feasibility of a proposed explanation]]
...
[[NOTE:A capsule summary of the immune response: Vertebrates have a
...
\noindent \includegraphics[width=\linewidth]{../ps/calc2/andmay1.pdf}
...
\item Since the velocity vectors differ so much in their size,
  we [[NOTE:Knowing the direction of the trajectories is often
...
\item Since the range of values we want to represent is so
  ...
  space.
[[NOTE:Expressing graphical information over several different orders of magnitude]]
...
\noindent \includegraphics[width=\linewidth]{../ps/calc2/andmay3.pdf}
...
\label{subsubsec:two-species-interactions}
...
\begin{enumerate}
\item Below are four predator-prey models.  In each model all the
...
\end{itemize}
  ...
  \begin{enumerate}
  \item The original Lotka--Volterra model, proposed independently in the
...
\end{align*}
  ...
  \item The Leslie--Gower model.\index{Leslie--Gower model}
\begin{align*}
R' &= aR-bRF, \\
...
\end{align*}
  ...
  \item Leslie--Gower with carrying capacity for rabbits.
\begin{align*}
...
\end{enumerate}
\item {\bf Symbiosis and mutualism}\index{symbiosis}\index{mutualism}.
...
\end{align*}
  ...
  \begin{enumerate}
  \item Do these equations describe symbiosis?  What terms account for
symbiosis?

  \item Each equation has a negative term in it.  What aspect of reality
is this term capturing?

  \item Sketch the vector field for this system in the $B$-$C$ plane.
Find the equilibrium points, and mark them on your sketch.

  \item Draw some trajectories on your sketch, and use them to determine
the stability of the equilibrium points.

  \item Suppose an acre of land has 10,000 pounds of clover on it, and a
...
drawing a trajectory and by describing the situation in words.
  ...
  \item Let a couple of years pass after the situation in part (e) has
...
Does it stay down, or does it recover?  Does the clover grow back?
  ...
  \item This scenario is an alternative to part (f); it is also played
...
\end{enumerate}
\item {\bf Competition}\index{competition} As a third kind of feedback
...
compete.  The purpose of this exercise is to decide these questions.
  ...
  \begin{enumerate}
  \item Suppose we start with $x = y = 10$.  What are the two growth
...
Y?
  ...
  \item How many equilibrium points does this system have, and where are
they?

  \item Sketch {\em and label\/} in the $x$-$y$ plane the points where
...
\noindent [Note: Only three of the zones actually occur in the first
  ...
  \item Sketch on the $x$-$y$ plane the trajectory that starts at the
...
either X or Y eventually vanish?
  ...
  \item Is the outcome of part (d) typical, or is it not?  Try several
...
computer to confirm your analysis.
  ...
  \item Describe the type of each equilibrium point you found in part
(a).  Is any equilibrium an attractor?


\end{enumerate}
\item \label{`basins'} {\bf Fairer competition}.  The vector field in
...
\end{align*}
  ...
  \begin{enumerate}
  \item Sketch and label in the $x$-$y$ plane the points where $x' = 0$
and where \mbox{$y' = 0$}.  Sketch representative vectors for the vector
field.  Mark all equilibrium points.

  \item What happens to a population consisting of 10 individuals each
...
\end{enumerate}
\item {\bf More on the Lotka--Volterra model}\index{Lotka--Volterra
...
$b=.005$, $c=.00004$, and $d=.04$.
  ...
  \begin{enumerate}
  \item Sketch the vector field, together with some typical trajectories,
...
negative $F$ value?
  ...
  \item For this exercise you will need to go back to a computer program
...
looks like it closes?  Can you explain this phenomenon?
...
message.) Can you explain this? (Think about your answer to part (a).)
  ...
  \item {\bf Getting a first integral for the system}\quad Show
...
evaluate the constant.
  ...
  \item Show that the function $f(R)=cR-d\ln R$
...
\begin{enumerate}
\item Suppose instead of an idealized frictionless pendulum, we wanted
...
\label{subsubsec:the-anderson--may-model}




\begin{enumerate}
\item Consider $dE_1/dt=\Lambda_1-\mu_1E_1+a_1E_1E_2/(1+b_1E_1E_2)$.
...
\item In\label{AMay2} the same book---{\em Infectious Diseases of
...
determined by their product.
  ...
  \begin{enumerate}
  \item Show that in the absence of any virus, the effector cells have a
stable equilibrium of $\Lambda /\mu$.

  \item Perform a state space analysis of the vector field.  Note that
...
\label{sec:local-behavior-of-dynamical-systems}
\label{sec-eqs}

\subsection{A Microscopic View}
\label{subsec:a-microscopic-view}

One of the themes of this book has been the concept of the ``microscope''.  
[[NOTE:Phase portraits under the microscope]]
...
\noindent \includegraphics[width=\linewidth]{../ps/calc2/locbeha1.pdf}
...
\noindent \includegraphics[width=\linewidth]{../ps/calc2/locbeha2.pdf}
...
[[NOTE:Near an ordinary point, a vector field is  almost constant]]
...
[[NOTE:Near an ordinary point all trajectories look  the same]]
...
Near an 
[[NOTE:Equilibrium points  are different]]
...
\noindent \includegraphics[width=\linewidth]{../ps/calc2/locbeha3.pdf}
...
[[NOTE:Linear approximation of the vector field]]
...
and $f_2$ are just
[[NOTE:To linearize a vector field, linearize the functions that determine it]]
...
[[NOTE:General form for the local linearization at  an equilibrium point\ldots]]
...
For completeness, 
[[NOTE:\ldots and at  a generic point]]
...
\begin{enumerate}
\item Find the local linearizations at all the equilibrium points in
exercises 2--4 at the end of the previous section.


\item The Lotka--Volterra equations
\begin{align*}
R' &= aR-bRF, \\
F' &= cRF-dF,
\end{align*}
have an equilibrium point at $(R, F) = 00(d/c, a/b)$.
  ...
  \begin{enumerate}
  \item What is the local linearization there?

  \item What is a striking feature of this linearization, and what is its
physical significance?

  \item The trajectories for the local linearizations turn out to be
...
\end{enumerate}
\item Find the local linearization at the point $P_1$ in the
...
\item Go back to the second Anderson--May model analyzed in problem~8
...
\label{sec:a-taxonomy-of-equilibrium-points}
\label{taxonomy}

In the exercises and examples we have seen so far in this chapter, 
[[NOTE:An intuitive classification of equilibrium points]] 
...
[[NOTE:The existence or not of straight line trajectories and how to
...
\noindent \includegraphics[width=\linewidth]{../ps/calc2/classeq1.pdf}
...
\noindent \includegraphics[width=\linewidth]{../ps/calc2/classeq2.pdf}
...
\noindent \includegraphics[width=\linewidth]{../ps/calc2/classeq3.pdf}
...
One pair of fixed lines, all trajectories flowing toward the equilibrium (attractors) or away from it (repellors).

\noindent \includegraphics[width=\linewidth]{../ps/calc2/classeq4.pdf}



\subsubsection{Center.}
No fixed lines, all trajectories flowing around the
equilibrium in closed loops.  \index{neutral point}\index{equilibrium
  point!neutral}

\noindent \includegraphics[width=\linewidth]{../ps/calc2/classeq5.pdf}
...
\label{subsec:straight-line-trajectories}
...
[[NOTE:The condition for a fixed-line trajectory]]
...
\label{subsubsec:attractors-and-basins-of-attraction}
...
\begin{enumerate}
\item In this exercise we look at a number of different linear systems
...
of.
  ...
  \begin{enumerate}
  \item $r' = 4r + s$, \hspace{.25in} $s' = 2r + 3s$.

  \item $r' = 4r + s$, \hspace{.25in} $s' = -2r + 3s$.

  \item $r' = 2r + 3s$, \hspace{.25in} $s' = 4r + s$.

  \item $r' = -4r + 4s$, \hspace{.25in} $s' = 2r + s$.

  \item $r' = -.4r - 4s$, \hspace{.25in} $s' = 2r - .5s$.

  \item $r' = -.4r - 4s$, \hspace{.25in} $s' = 2r + .4s$.

  \item Make up and analyze four more linear systems.


\end{enumerate}
\item If you start with a given linear system and consider the related
...
\item Use the quadratic formula to find the general solution to the
equation
        \[
m=\frac{c+dm}{a+bm}.
\]
  ...
  \begin{enumerate}
  \item In exercises 1, 3, and 4 in the previous section you found local
...
the origin or away from it.
  ...
  \item What is the general condition for a linear dynamical system to
have straight-line trajectories?


\end{enumerate}
\item Make up a system that has the lines of slope $\pm 1$ as
trajectories.


\item What is the condition for a system to have exactly one fixed
line?  Construct a couple of systems that have only one fixed line and
sketch their phase portraits.


\item {\bf Degeneracy}\quad The analysis developed in this section
...
between the linearized and unlinearized forms.
  ...
  \begin{enumerate}
  \item $r' = r^2$, \hspace{.25in} $s' = -s$.  You should see sort of a
hybrid between a saddle point and an attractor here.

  \item $r' = r^2+s^2$, \hspace{.25in} $s' = r$.



\end{enumerate}
\item Use the technique presented at the end of this section
(page~\pageref{`boundary'} to graph the boundary between the two
basins of attraction.

  \begin{enumerate}
  \item In the same way, construct the boundary between the two basins in
...
\label{subsubsec:distance-from-the-origin}
...
\end{align*}
  ...
  \begin{enumerate}
  \item Show that if we look at points on the line of slope $m$, so that
...
\]
  ...
  \item Use the quadratic formula to conclude that this happens precisely
where
        \[
...
\]
  ...
  \item Show in particular, if $(b+c)^2-4ad<0$, there are no solutions to
...
\end{enumerate}
\item Choose four of the exercise in the first part of this section and
analyze them to see where (and whether) trajectories have a closest
approach to the origin.


\item Use the results of this section to construct a dynamical system
whose trajectories are spirals that are always moving away from the
origin.

  \begin{enumerate}
  \item Use the results to construct a dynamical system whose
...
\end{enumerate}
\item It turns out that trajectories which form closed loops should
...
\item Write down the equations of some dynamical systems that will have
closed orbits.
...
\noindent \includegraphics[width=\linewidth]{../ps/calc2/limcyc.pdf}
...
[[NOTE:Limit cycles give models for cyclic behavior]] 
...
\begin{enumerate}
\item Using the parameter values given in the text, find the
coordinates of the equilibrium point at the center of the limit cycle
and show that it is, in fact, a repellor.


\item May's model is interesting in that it exhibits a phenomenon known
...
\label{sec:beyond-the-plane-three-dimensional-systems}
...
\noindent \includegraphics[width=\linewidth]{../ps/calc2/ctr.pdf}
...
\noindent \includegraphics[width=\linewidth]{../ps/calc2/cycle.pdf}
...
\noindent \includegraphics[width=\linewidth]{../ps/calc2/torus.pdf}
...
\noindent \includegraphics[width=\linewidth]{../ps/calc2/lor.pdf}
...
\begin{enumerate}
\item Consider a system consisting of three species: giant carnivorous
...
\end{align*}
  ...
  \begin{enumerate}
  \item Find all equilibrium points of the system.  There are five, one
of which is physically impossible.  Describe the significance of the
other four.

  \item The most interesting equilibrium is the one in which all three
...
cover and the seed within). The mice have density~$z$.
...
interactions between the violets, ants and mice.
  ...
  \item Find all equilibrium points for the system.  Don't forget the
...
\end{align*}
  ...
  \item Localize the model at each of these equilibria, using local
coordinates $u$, $v$, and $w$ as before, and linearize.

  \item In the case of the equilibrium point (1000, 200, 4) the local
linearization is
\begin{align*}
u' &= -u + 2 v - 100 w, \\
v' &= .2 u - 2 v, \\
