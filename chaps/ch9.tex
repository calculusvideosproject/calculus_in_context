...
\label{chap:functions-of-several-variables}
...
[[NOTE:The problem of visualizing a function of several variables]]	
...
\label{sec:graphs-and-level-sets}

\noindent \includegraphics[width=\linewidth]{../ps/911/WEATHER1.pdf}
...
[[NOTE:Underground temperatures  fluctuate less]]	
...
\noindent \includegraphics[width=\linewidth]{../ps/911/WEATHER2.pdf}
...
[[NOTE:The phase shifts  with the depth]]
...
[[NOTE:Graphing temperature as a function of depth]]	
...
\noindent \includegraphics[width=\linewidth]{../ps/911/WEATHER3.pdf}

\label{depthgraph}


below surface at the beginning of July. 
[[NOTE:Reading a  surface graph]]
...
\noindent \includegraphics[width=\linewidth]{../ps/911/WEATHER5.pdf}



There is a definite connection between this surface and the two
collections of curves.
[[NOTE:Grid lines are slices of the surface that show how the function depends on each variable separately]]	
...
\noindent \includegraphics[width=\linewidth]{../ps/911/WEATHER6.pdf}
...
[[NOTE:Comparing the surface to its slices]]
...
\label{subsec:examples-of-graphs}

\noindent \includegraphics[width=\linewidth]{../ps/911/MINMAX1.pdf}
...
\label{subsubsec:a-minimum-z-x2-y2}
\index{minimum}

\noindent \includegraphics[width=\linewidth]{../ps/911/MIN2.pdf}
...
\label{subsubsec:a-minimax-z-x2---y2}
\index{minimax}

\noindent \includegraphics[width=\linewidth]{../ps/911/SADDLE1.pdf}
...
\noindent \includegraphics[width=\linewidth]{../ps/911/SADDLE2.pdf}

\noindent \includegraphics[width=\linewidth]{../ps/911/SADDLE3.pdf}

\noindent \includegraphics[width=\linewidth]{../ps/911/SADDLE4.pdf}
...
z)$.
[[NOTE:The points where $y = c$ form a vertical plane parallel to the $x, z$-plane]]
...
[[NOTE:The points where $x = c$ form a vertical plane parallel to the
  $y, z$-plane]]
...
[[NOTE:As you can see, it is valuable for you to be able to generate
...
\label{subsubsec:a-cubic-z-x3---4x---y2}
\label{cubic}
...
\noindent \includegraphics[width=\linewidth]{../ps/911/CUBIC1.pdf}

\noindent \includegraphics[width=\linewidth]{../ps/911/CUBIC2.pdf}




a maximum.  
[[NOTE:The surface  has a saddle]]
...
\noindent \includegraphics[width=\linewidth]{../ps/911/CUBIC3.pdf}

\noindent \includegraphics[width=\linewidth]{../ps/911/CUBIC4.pdf}

\noindent \includegraphics[width=\linewidth]{../ps/911/CUBIC5.pdf}


The small figures on the right show the same surface as the large
[[NOTE:See the graph from different viewpoints]]	
...
\label{subsubsec:energy-of-the-pendulum-e-1---costheta}

\noindent \includegraphics[width=\linewidth]{../ps/911/PENDEN1.pdf}

\noindent \includegraphics[width=\linewidth]{../ps/911/PENDEN2.pdf}
...
[[NOTE:One way to describe what happens to a real pendulum---that is,
...
\label{subsec:from-graphs-to-levels}

\noindent \includegraphics[width=\linewidth]{../ps/912/DENSITY2.pdf}

\noindent \includegraphics[width=\linewidth]{../ps/912/DENSITY1.pdf}
...
\noindent \includegraphics[width=\linewidth]{../ps/912/DENSITY3.pdf}
...
\noindent \includegraphics[width=\linewidth]{../ps/912/DENSITY4.pdf}

\noindent \includegraphics[width=\linewidth]{../ps/912/density5.pdf}
...
[[NOTE:These density plots show a ``checkerboard'' pattern because
  {\em Mathematica\/} (the computer program that
...
[[NOTE:From densities  to contours]]
...
\noindent \includegraphics[width=\linewidth]{../ps/913/CONTOUR1.pdf}  
...
concentric ovals.
[[NOTE:Contours of the standard functions]]
...
\noindent \includegraphics[width=\linewidth]{../ps/913/CONTOUR2.pdf}

\noindent \includegraphics[width=\linewidth]{../ps/913/CONTOUR3.pdf}

\noindent \includegraphics[width=\linewidth]{../ps/913/CONTOUR4.pdf}  
...
[[NOTE:Contours are  horizontal slices  of a graph]]
...
\noindent \includegraphics[width=\linewidth]{../ps/913/CONSURF1.pdf}

\noindent \includegraphics[width=\linewidth]{../ps/913/CONSURF2.pdf}

\label{standard min max-end}

To get some more experience with contour plots, we return to 
[[NOTE:Energy of the pendulum, again]]	
...
\noindent \includegraphics[width=\linewidth]{../ps/913/contour5.pdf}
...
[[NOTE:Energy contours  are trajectories  of the dynamics]]	
...
\noindent \includegraphics[width=\linewidth]{../ps/913/contour6.pdf}
...
\noindent \includegraphics[width=\linewidth]{../ps/914/SUMDENSE.pdf}

\noindent \includegraphics[width=\linewidth]{../ps/914/SUMCON2.pdf}

\noindent \includegraphics[width=\linewidth]{../ps/914/sumcon4.pdf}
...
[[NOTE:We find density plots everywhere.  A photograph is a density
...
\label{subsubsec:the-pros-and-cons}
...
[[NOTE:Plots are visually economical in comparison to graphs]]	
...
\noindent \includegraphics[width=\linewidth]{../ps/915/XYZ1.pdf}
...
\noindent \includegraphics[width=\linewidth]{../ps/915/SHELLS1.pdf}



Below is the contour plot of another standard function 
[[NOTE:A standard minimax]]	
...
page~\pageref{saddle}.)
[[NOTE:The contours  are hyperbolic shapes]]	
...
\noindent \includegraphics[width=\linewidth]{../ps/915/SHELLS2.pdf}

\noindent \includegraphics[width=\linewidth]{../ps/915/SHELLS3.pdf}



It is a general fact---and our two examples 
[[NOTE:When there are three input variables, the contours are surfaces]]	
...
\item Obtain the graph of $z = 2x - y$ on the domain $-2 \leq x \leq
2$, $-2 \leq y \leq 2$.  What is the shape of the graph?

  \begin{enumerate}
  \item Graph the same function of the domain $2 \leq x \leq 6$, $0 \leq
y \leq 4$.  What is the shape of the graph?  How does this graph
compare to the one in part (a)?


\end{enumerate}
\item Continuation.  Sketch three different slices of the graph of $z
= 2x - y$ in the $y$-direction.  What do the slices have in common?
How are they different?

  \begin{enumerate}
  \item Answer the same questions for slices in the $x$-direction.


\end{enumerate}
\item Obtain the graph of $z = .3 x + .8 y + 2.3$; choose the domain
yourself.  Where does the graph intercept the $z$-axis?

  \begin{enumerate}
  \item Describe the vertical slices of this graph in the $y$-direction
and in the $x$-direction.


\end{enumerate}
\item Describe the vertical slices of the graph of $z = px + qy + r$ in
the $y$-direction and in the $x$-direction.


\item Compare the contours of the function $z = x^2 + 2 y^2$ to those
of $z = x^2 + y^2$.

  \begin{enumerate}
  \item What is the shape of the graph of $z = x^2 + 2 y^2$?  Decide this
...
\end{enumerate}
\item Obtain a contour plot of the function $z = x^2 + xy + y^2$.

  \begin{enumerate}
  \item What is the shape of the graph of $z = x^2 + xy + y^2$?  Decide
this first using only the information you have about the contours.
Then use a computer to obtain the graph.


\end{enumerate}
\item Obtain a contour plot of the function $z = x^2 + 3xy + y^2$.

  \begin{enumerate}
  \item What is the shape of the graph of $z = x^2 + 3xy + y^2$?  Decide
this first using only the information you have about the contours.
Then use a computer to obtain the graph.


\end{enumerate}
\item Obtain a contour plot of the function $z = x^2 + 2xy + y^2$.

  \begin{enumerate}
  \item What is the shape of the graph of $z = x^2 + 2xy + y^2$?  Decide
this first using only the information you have about the contours.
Then use a computer to obtain the graph.


\end{enumerate}
\item Complete this statement: The function $f(x, y; p) = x^2 + p xy +
4 y^2$, which depends on the parameter $p$, has a minimum at the
origin when \rule[-1pt]{30pt}{.3pt} and a minimax when
\rule[-1pt]{30pt}{.3pt}\,.


\item Obtain the graph and a terraced density plot of the function $z
= 3x^2 + 17 xy + 12 y^2$.  What is the shape of the graph?

  \begin{enumerate}
  \item What is the shape of the contours?  Indicate how the contours fit
on the graph.
...
\end{enumerate}
\item Obtain the graph of $z = f(x, y) = xy$ on the domain $-3 \leq x
\leq 3$, $-3 \leq y \leq 3$.  Does this function have a maximum or a
minimum or a saddle point?  Where?


\item Continuation.  Sketch slices of the graph of $z = xy$ in the
$y$-direction, for each of the values $x = -2$, $-1$, 0, 1, and 2.
What is the general shape of each of these slices?

  \begin{enumerate}
  \item Repeat part (a), but make the five slices in the
$x$-direction---that is, fix $y$ instead of $x$.


\end{enumerate}
\item Continuation.  Show how the slices you obtained in the previous
exercise fit (or appear) on the graph you obtained in the exercise
just before that one.


\item Continuation.  Let $x = u + v$ and $y = u - v$.  Express $z$ in
terms of $u$ and $v$, using the fact that $z = xy$.  Then obtain the
graph of $z$ as a function of the new variables $u$ and $v$.

  \begin{enumerate}
  \item What is the shape of the graph you just obtained?  Compare it to
the graph of $z = xy$ you obtained earlier.


\end{enumerate}
\item Can you draw a network of straight lines on the saddle surface $z
= x^2 - y^2$?


\item Obtain a terraced density plot of $z = xy$.  How do the contours
of this plot fit on the graph of $z = xy$ you obtained in a previous
exercise?


\item The graphs of $z = x^2 + 5 xy + 10 y^2$ and $z = 3$ intersect in
a curve.  What is the shape of that curve?


\item The graphs of $z = x^2 + y^3$ and $z = 0$ intersect in a curve.
What is the shape of that curve?


\item The graphs of $z = 2x - y$ and $z = .3 x + .8 y + 2.3$ intersect
in a curve.  What is the shape of that curve?


\end{enumerate}
\subsubsection{First integrals}
\label{subsubsec:first-integrals}

\index{first integral}


\begin{enumerate}
\item A hard spring\index{hard spring}\index{spring!hard} described by
...
chapter~7.3, especially exercise~13, page~\pageref{spring energy}.)
  ...
  \begin{enumerate}
  \item Let $c = 16$ and $\beta = 1$.  Obtain the graph of $E(x, v)$ on a
domain that has the origin at its center.  Locate all the minimum,
maximum, and saddle points in this domain.

  \item What is the state of the spring (that is, its position $x$ and
its velocity $v$) when it has minimum energy?


\end{enumerate}
\item A soft spring\index{soft spring}\index{spring!soft} described by
the dynamical system
\[
...
(See exercise~16, page~\pageref{ln first int}.)  
  ...
  \begin{enumerate}
  \item Obtain the graph of $E(x, v)$.  Experiment with different
possibilities for the domain until you get a good representation.

  \item Obtain a terraced density plot of $E(x, v)$ over the same domain
you chose in part (a).  Compare the two representations of $E$.

  \item Does the spring have a state of minimum energy?  If so, where is
it?

  \item Does the spring have a state of {\em maximum\/} energy?  Explain
your answer.
...
y \leq 50$?)
  ...
  \begin{enumerate}
  \item Find all maximum, minimum, and saddle points on this graph.  What
is the connection between the maximum of $E$ and the equilibrium point
of the dynamical system?

  \item Obtain a contour plot of $E$ on the same domain as in part (a).
...
\end{enumerate}
\item Continuation.  Here is another first integral of the same
...
previous exercise.
  ...
  \begin{enumerate}
  \item Obtain a contour plot of $H$, and compare the contours to the
...
\label{subsec:microscopic-views}
...
\noindent \includegraphics[width=\linewidth]{../ps/921/micro1.pdf}

\noindent \includegraphics[width=\linewidth]{../ps/921/micro2.pdf}

\noindent \includegraphics[width=\linewidth]{../ps/921/micro3.pdf}
...
\noindent \includegraphics[width=\linewidth]{../ps/921/micro4.pdf}
...
\label{subsec:linear-functions}
\index{linear function}
\index{function!linear}

A linear function 
[[NOTE:Responses to  changes in input]]	
...
[[NOTE:Partial and  total changes]]	
...
[[NOTE:Another way  to describe a  linear function]]	
...
{\bf Alternate definition}. The function $z = f(x_1, x_2, \ldots, x_n)$\\
      ...
      which
        ...
        $\displaystyle \Delta z = p_1 \cdot \Delta x_1 + p_2 \cdot \Delta x_2 +
	 	\cdots + p_n \cdot \Delta x_n.$
}}
}
\end{picture}
...
\label{subsubsec:formulas-for-linear-functions}

When $z = f(x_1, x_2, \ldots, x_n)$ is a linear function, 
[[NOTE:From the definition  to a formula]]	
...
\noindent$\bullet$ {\bf The initial-value form}.\index{linear function!initial-value form}\index{initial-value form}
[[NOTE:Given the partial  rates of change and  an initial point]]
...
\noindent$\bullet$ {\bf The intercept form}.\index{linear function!intercept
  form}\index{intercept form}
[[NOTE:Given the partial  rates of change and  the $z$-intercept]]
...
[[NOTE:The form of  a linear function  of $n$ variables]]	
...
\label{subsubsec:the-graph-of-a-linear-function}
...
\noindent \includegraphics[width=\linewidth]{../ps/922/linear1.pdf}

\noindent \includegraphics[width=\linewidth]{../ps/922/linear2.pdf}
...
\noindent$\bullet$ it has slope\index{slope} $p$ in the $x$-direction;

\noindent$\bullet$ it has slope $q$ in the $y$-direction.

\noindent$\bullet$ it intercepts the $z$-axis at $z = r$; 


Let's see how we can {\em deduce\/} 	 
[[NOTE:The definition of  a linear function  implies that its graph  is a
  flat plane]]
...
\noindent \includegraphics[width=\linewidth]{../ps/922/linear3.pdf}
...
\label{subsubsec:geometric-interpretation-of-the-partial-rates}
...
[[NOTE:Partial rates and partial slopes]]	
...
\noindent \includegraphics[width=\linewidth]{../ps/922/linear4.pdf}

\noindent \includegraphics[width=\linewidth]{../ps/922/linear5.pdf}
...
not affected.  
[[NOTE:The overall tilt  of a graph is altered]]
...
+4$).
[[NOTE:Partial rate and the spacing of contours]] 	
...
\noindent \includegraphics[width=\linewidth]{../ps/922/linear6.pdf}

\noindent \includegraphics[width=\linewidth]{../ps/922/linear7.pdf}

\noindent \includegraphics[width=\linewidth]{../ps/922/linear8.pdf}
...
[[NOTE:The larger  the partial rate,  the closer  the contours]] 
...
\label{subsec:the-gradient-of-a-linear-function}
...
[[NOTE:The vector of  partial rates]]	
...
[[NOTE:The direction of  most rapid growth]]	
...
\noindent \includegraphics[width=\linewidth]{../ps/922/linear9.pdf}

\noindent \includegraphics[width=\linewidth]{../ps/922/linear10.pdf}

\noindent \includegraphics[width=\linewidth]{../ps/922/linear11.pdf}

Of course, the answer will depend on the linear function.  
[[NOTE:\hspace{-20pt} $z = -\tfrac{1}{2} x + y + 4$]]		
...
[[NOTE:The magnitude of  most rapid growth]]
...
\noindent \includegraphics[width=\linewidth]{../ps/922/linear12.pdf}
...
[[NOTE:Information from  the gradient]]	
...
[[NOTE:End of the proof]]
so we have confirmed that the length of the gradient is equal to the
maximum rate of increase.

\noindent \includegraphics[width=\linewidth]{../ps/922/linear13.pdf}

\noindent \includegraphics[width=\linewidth]{../ps/922/linear14.pdf}

\noindent \includegraphics[width=\linewidth]{../ps/922/linear15.pdf}
...
[[NOTE:Contour spacing and  the length  of the gradient]]
...
[[NOTE:The gradient points directly uphill]]	
...
\noindent \includegraphics[width=\linewidth]{../ps/922/linear16.pdf}
...
\label{subsec:the-microscope-equation}
\index{microscope equation}

\subsubsection{Local linearity}
\label{subsubsec:local-linearity}
\index{local linearity}
...
\noindent \includegraphics[width=\linewidth]{../ps/922/linear18.pdf}

\noindent \includegraphics[width=\linewidth]{../ps/922/linear17.pdf}
...
Functions that are
[[NOTE:The relation between calculus and fractals]]	
...
{\bf Calculus studies functions that are} \\
...
\label{subsubsec:the-microscope-equation-with-two-input-variables}

If the function $z = f(x, y)$ is locally linear, 
[[NOTE:The equation of a microscopic view]]	
...
[[NOTE:The microscope equation in the $x$-direction\ldots]]	
...
[[NOTE:\ldots and in the $y$-direction]]	
at $y = b$ is
	\[
...
\noindent \includegraphics[width=\linewidth]{../ps/921/micro5.pdf}

\noindent \includegraphics[width=\linewidth]{../ps/921/micro6.pdf}


The separate microscope equations 
[[NOTE:From partial changes  to total change]]	
...
[[NOTE:The microscope equation gives  a linear approximation]]	
...
The
[[NOTE:Comparing the contours \ldots]]
...
\noindent \includegraphics[width=\linewidth]{../ps/922/micro7.pdf}



We can also compare 
[[NOTE:\ldots and the graph  of the function and its linear approximation]] 
...
\noindent \includegraphics[width=\linewidth]{../ps/923/micro9.pdf}

\noindent \includegraphics[width=\linewidth]{../ps/923/micro10.pdf}
...
\noindent \includegraphics[width=\linewidth]{../ps/923/micro11.pdf}

\noindent \includegraphics[width=\linewidth]{../ps/923/micro12.pdf}


There are many different ways 
[[NOTE:Elliptic points\ldots]]
...
\noindent \includegraphics[width=\linewidth]{../ps/923/micro13.pdf}
...
[[NOTE:\ldots and  hyperbolic points]]	
...
[[NOTE:The curve of intersection between a surface and a shifted
  tangent plane is called the {\em Dupin indicatrix}. The Dupin indicatrix can take many forms besides the
...
[[NOTE:The classification of the points into elliptical, parabolic,
  and hyperbolic types is one of the first steps in studying the
  curvature of a surface. This is part of {\em
  ...
  relativity) and the subatomic (string
  theory).]]


\subsection{The Gradient} 
\label{subsec:the-gradient}
\index{gradient}

Local linearity is a powerful principle.\index{local linearity}  
[[NOTE:Consequences of  local linearity]]	
...
\noindent$\bullet$ the contours are straight, parallel, and equally spaced;

\noindent$\bullet$ the graph is a flat plane (the tangent plane);

\noindent$\bullet$ the function has a linear formula (the microscope equation);

\noindent$\bullet$ the partial derivatives are the slopes of the graph in the \\
\mbox{} \qquad directions of the axes.


There is one more aspect of a linear function 
[[NOTE:Extending the gradient to non-linear functions]]
...
point to point.
[[NOTE:The gradient  vector field]]
...
{\bf Example}.  \quad $f(x, y) = x^3 - 4x - y^2$, \quad
	[[NOTE:Contours and gradient vectors together]] 
$\mbox{grad $f$} = (3x^2 - 4, -2y)$

\noindent \includegraphics[width=\linewidth]{../ps/924/grad1.pdf}

\noindent \includegraphics[width=\linewidth]{../ps/924/grad2.pdf}




There is one thing you should notice about the previous figure: 
[[NOTE:The vectors are rescaled for clarity]]
...
[[NOTE:The relation between gradients and contours]]	
...
\label{subsec:the-gradient-of-a-function-of-three-variables}
...
In the two boxes below you can compare the gradient
field of $f(x, y, z) = x^2 + y^2 - z^2$ with its level sets.
[[NOTE:Visualizing a three-dimensional vector field]]
...
\noindent \includegraphics[width=\linewidth]{../ps/925/shells4.pdf}

\noindent \includegraphics[width=\linewidth]{../ps/924/grad4.pdf}
...
\begin{enumerate}
\item Obtain the graph of $z = x^3 - 4x - y^2$ on a domain centered at
the point $(x, y) = (1.5, -1)$, and magnify the graph until it looks
like a plane.

  \begin{enumerate}
  \item Estimate, by eye, the slopes in the $x$-direction and the
$y$-direction of the plane you found in part (a).  [You should find
  numbers between +2 and +3 in both cases.]


\end{enumerate}
\item Obtain a contour plot of $z = x^3 - 4x - y^2$ on a domain
...
\item Continuation.  The purpose of this exercise is to estimate the
rate of change $\Delta z/\Delta x$ at $(x, y) = (1.5, -1)$, using the
most highly magnified contour plot you constructed in the last
exercise.

\noindent \includegraphics[width=\linewidth]{../ps/925/contour1.pdf}


  \begin{enumerate}
  \item What is the horizontal spacing $\Delta x$ between the two
contours closest to the point $(1.5, -1)$?  See the illustration at
the right.

  \item Find the $z$-levels $z_1$ and $z_2$ of those contours, and then
compute $\Delta z = z_2 - z_1$.

  \item Compare the value of $\Delta z/\Delta x$ you now obtain with the
slope in the $x$-direction that you estimated in exercise~1.


\end{enumerate}
\item Continuation.  Repeat all the work of the last exercise, this
time for $\Delta z/\Delta y$.

\end{enumerate}
\subsubsection{Linear functions}
\label{subsubsec:linear-functions}



\begin{enumerate}
\item Find the $z$-intercept of the graph of the linear function given
by the formula
	\[
z - 3 = 2 (x - 4) - 3 (y + 1).
\]
  ...
  \begin{enumerate}
  \item Write the formula for this linear function in intercept form.


\end{enumerate}
\item Write, in initial-value form, the formula for the linear
function $z = L(x, y)$ for which $\Delta z/\Delta x = 3$, $\Delta
z/\Delta y = -2$, and $L(1, 4) = 0$.

  \begin{enumerate}
  \item Write the intercept form of the same function.  What is the
$z$-intercept of the graph of $L$?


\end{enumerate}
\item Suppose $z$ is a linear function of $x$ and $y$, and $\Delta
z/\Delta x = -7$, $\Delta z/\Delta y = 12$.  If $(x, y)$ changes from
$(35, 24)$ to $(33, 33)$, what is the total change in $z$?

  \begin{enumerate}
  \item Suppose $z = 29$ when $(x, y) = (35, 24)$.  What value does $z$
have when $(x, y) = (33, 33)$?  What value does $z$ have when $(x, y)
= (0, 0)$?

  \item Write the intercept form of the formula for $z$ in terms of $x$ and $y$.



\end{enumerate}
\item Suppose $z$ is a linear function of $x$ and $y$ for which we have
...
\addtolength{\arraycolsep}{-8pt}
  ...
  \item Write the formula for $z$ in intercept form.


\end{enumerate}
\item Sketch the graph of $z = x - 2y + 7$ on the domain $0 \leq x
\leq 3$, $0 \leq y \leq 3$.

  \begin{enumerate}
  \item Determine the slope of this graph in the $x$-direction, and
indicate on your sketch where this slope can be found.

  \item Determine the slope of this graph in the $y$-direction, and
indicate on your sketch where this slope can be found.


\end{enumerate}
\item Continuation.  Draw the gradient vector of $z = x - 2y + 7$ in
...
\item Sketch the graph of the linear function $z = L(x, y)$ for which
	\[
...
\]
  ...
  \begin{enumerate}
  \item Determine the partial rates of change $\Delta z/\Delta x$ and
$\Delta z/\Delta y$.

  \item Where is the $z$-intercept of the graph?

  \item If $(4, 1, c)$ is a point on the graph, what is the value of $c$?

  \item Is the point $(2, 2, 4)$ on the graph?  Explain your position.

\noindent \includegraphics[width=\linewidth]{../ps/925/linear1.pdf}

\noindent \includegraphics[width=\linewidth]{../ps/925/linear2.pdf}



\end{enumerate}
\item The figure on the left above is the contour plot of a function $z
= L_1(x, y)$.

  \begin{enumerate}
  \item What are the values of $L_1(1, 0)$, $L_1(2, 0)$, $L_1(3, 0)$,
$L_1(0, 3)$, $L_1(2, 3)$, and $L_1(0, 0)$?

  \item What are the partial rates $\Delta L_1/\Delta x$ and $\Delta
L_1/\Delta y$?


\end{enumerate}
\item Continuation.  Find the values of $L_1(3, 2)$, $L_1(7, 0)$,
$L_1(7, 7)$, $L_1(1.4, 2.9)$, $L_1(-2, 9)$, $L(-10, -100)$.

  \begin{enumerate}
  \item Find $x$ so that $L_1(x, 0) = 0$.  Find $y$ so that $L_1(0, y) =
0$.


\end{enumerate}
\item Continuation.  Write the intercept form of the formula for
$L_1(x, y)$.


\item Find the partial rates $\Delta L_2/\Delta x$ and $\Delta
L_2/\Delta y$ of the linear function $L_2$ whose contour plot is shown
at the right on the previous page.

  \begin{enumerate}
  \item Obtain the intercept form of the formula for $L_2(x, y)$.

\noindent \includegraphics[width=\linewidth]{../ps/925/graph1.pdf}

\noindent \includegraphics[width=\linewidth]{../ps/925/graph2.pdf}



\end{enumerate}
\item The figures above are the graphs of $L_1$ and $L_2$.  Which is
...
\item Determine the gradient vectors of $L_1$ and $L_2$.

  \begin{enumerate}
  \item Sketch the gradient vector of each function on the $x,y$-plane
and on its own graph.  Does the gradient point directly uphill in each
case?


\end{enumerate}
\item Suppose the gradient vector of the linear function $p = L(q, r)$
is grad $p = \nabla p = (5, -12)$.  If $L(9, 15) = 17$, what is the
value of $L(11, 11)$?


\item What is the gradient vector of the function $w = 2 u + 5 v$?

  \begin{enumerate}
  \item At what point on the circle $u^2 + v^2 = 1$ does $w$ have its
largest value?  What is that value?


\end{enumerate}
\item Write the formula of a linear function $z = L(x, y)$ whose
gradient vector is grad $z = \nabla z = (-3, 4)$


  \begin{enumerate}
  \item Using your formula for $L$, calculate the total change in $L$
when $\Delta x = 2$, $\Delta y = 1$.


\end{enumerate}
\item Continuation; in particular, continue to use your formula for $z
= L(x, y)$.  What is the value of $L(0, 0)$?

  \begin{enumerate}
  \item What is the maximum value of $z$ on the circle $x^2 + y^2 = 1$?
At what point $(x, y)$ does $z$ achieve that value?

  \item Determine the difference between the maximum and minimum values
...
\end{enumerate}
\item What value does $z = 7x + 3 y + 31$ have when $x = 5$ and $y =
2$?

  \begin{enumerate}
  \item If $x$ increases by 2,
[[NOTE:The concept of   a {\em trade-off\/}]]
...
page~\pageref{trade off}.)
  ...
  \item What is the trade-off in $y$ when $x$ increases by $\alpha$?

  \item What is the trade-off in $x$ when $y$ increases by $\beta$?


\end{enumerate}
\item Suppose $z = L(x, y)$ is a linear function for which $\Delta
z/\Delta x = 5$ and $\Delta z/\Delta y = -2$.  What is the trade-off
in $y$ when $x$ increases by 50?

  \begin{enumerate}
  \item What is the trade-off in $x$ when $y$ increases by 1?


\end{enumerate}
\item Suppose $z = L(x, y)$ is a linear function and suppose the
trade-off in $y$ when $x$ increases by 1 is $-4$.

  \begin{enumerate}
  \item What is the trade-off in $y$ when $x$ is {\em decreased\/} by 3?

  \item What is the trade-off in $x$ when $y$ is increased by 10?  [Note
  that $x$ and $y$ are reversed here, in comparison to the earlier
  parts of this question.]


\end{enumerate}
\item Suppose $z = L(x, y)$ is a linear function for which we know
	\[
...
Suppose also that the trade-off in $y$ when $x$ increases by 10 is $-4$.
  ...
  \begin{enumerate}
  \item What is the value of $L(7, 7)$?

  \item If $L(7, \beta) = -2$, what is the value of $\beta$?

  \item What is the value of $\Delta z/\Delta y$?

  \item Write the formula for $L(x, y)$ in intercept form.


\end{enumerate}
\item Suppose the graph of the linear function $z = L(x, y)$ has a
...
$y$ change when $x$ is increased by the amount $\alpha$?
  ...
  \begin{enumerate}
  \item Suppose the partial slopes become $+1.5$ and $+2.4$ in the $x$-
and $y$-directions, respectively.  How does that affect the trade-off?
Explain.


\end{enumerate}
\item Sketch in the $x, y$-plane the set of points where $z = 2x + 3y
+ 7$ has the value 34.

  \begin{enumerate}
  \item If $x = 10$ then what value must $y$ have so that the point $(x,
y)$ is on the set in part (a)?

  \item If $x$ increases from 10 to 14, how must $y$ change so that the
...
[[NOTE:The set in the last question is called a {\em trade-off
    line}. Do you see that it is just a contour
  line by another name?]]


\end{enumerate}
\item Write, in intercept form, the formula for the linear function
	\[
...
\]
  ...
  \begin{enumerate}
  \item What is the gradient vector of the linear function in part (a)?


\end{enumerate}
\item Suppose the gradient of the linear function $w = L(x, y, z)$ is
$\nabla w = (1, -1, 4)$.  If $L(3, 0, 5) = 10$, what is the value of
$L(1, 2, 3,)$?


\item Describe the level sets of the function $w = f(x, y, z) = x + y +
z$.


\end{enumerate}
\subsubsection{The microscope equation}
\label{subsubsec:the-microscope-equation}



\begin{enumerate}
\item Find the microscope equation for the function $f(x, y) = 3 x^2 +
4 y^2$ at the point $(x, y) = (2, -1)$.


\item Continuation.  Use the microscope equation to estimate the
values of $f(1.93, -1.05)$ and $f(2.07, -.99)$


  \begin{enumerate}
  \item Calculate the {\em exact\/} values of the quantities in part (a),
and compare those values with the estimates.  In particular, indicate
how many digits of accuracy the estimates have.


\end{enumerate}
\item Find the microscope equation for the function $f(x, y, z) = x^2 y
\sin{z}$ at the point $(x, y, z) = (1, 1, \pi)$.


\item Suppose $f(87, 453) = 1254$ and
	\[
...
\item Continuation.  Find an estimate for $y$ to solve the equation
$f(87, y) = 1250$.

  \begin{enumerate}
  \item Find an estimate for $x$ to solve $f(x, 450) = 1275$.


\end{enumerate}
\item Continuation: a trade-off.  Go back to the starting values $x =
87$, $y = 453$, and $f(87, 453) = 1254$.  If $x$ increases from 87 to
88, how should $y$ change to keep the value of the function fixed at
1254?


\item Suppose $Q(27.3, 31.9) = 15.7$ and $Q(27.9, 31.9) = 15.2$.
Estimate the value of $\partial Q/\partial x(27.6, 31.9)$.

  \begin{enumerate}
  \item Estimate the value of $Q(27, 31.9)$.


\end{enumerate}
\item Suppose $S(105, 93) = 10$, $S(110, 93) = 10.7$, $S(105, 95) =
9.3$.  Estimate the value of $S(100, 100)$.  Explain how you made your
estimate.



\item Let $P$ be the point $(x, y, z) =(173, -29, 553)$.  Suppose $f(P)
= 48$ and
	\[
...
\item What is the equation of the tangent plane to the graph of $z =
xy$ at the point $(x, y) = (2, -3)$?

  \begin{enumerate}
  \item Which has a higher $z$-intercept: the graph or the tangent plane?


\end{enumerate}
\item Suppose the function $H(x, y)$ has the microscope equation
	\[
...
H$ at that point.
  ...
  \begin{enumerate}
  \item Pick the point exactly one unit away from $(35, 26)$ at which you
...
\end{enumerate}
\item Write the microscope equation for the function $V(x, y) = x^2 y$
at the point $(x, y) = (25, 10)$.


\item Continuation.
[[NOTE:Refer to the discussion of error propagation in chapter~3.4]]
...
volume?
  ...
  \begin{enumerate}
  \item Why is this a continuation of the previous question?


\end{enumerate}
\item Continuation.  Which causes a larger percentage error in the
calculated volume: a 1\% error in the measurement of the length of the
base, or a 1\% error in the measurement of the height?

\noindent \includegraphics[width=\linewidth]{../ps/925/cone.pdf}

\item A large basin in the shape of a cone is to be used as a water
reservoir.  If the radius $r$ is 186 meters and the depth $h$ is 31
meters, how much water can the basin hold, in cubic meters?


\item Continuation.  If there were a 3\% error in the measurement of
the radius, how much error would that lead to in the calculation of
the capacity of the basin?

  \begin{enumerate}
  \item If there were a 5\% error in the measurement of the depth, how
much error would there in the calculated capacity of the basin?

  \item If {\em both\/} errors are present in the measurements, what is
the total error in the calculated capacity of the basin?


\end{enumerate}
\item Continuation.  Suppose the measured radius of the basin ($r =
...
\item Continuation.  Suppose the accuracy of the radius measurement can
...
\noindent \includegraphics[width=\linewidth]{../ps/925/bowl.pdf}



\item Let's give the basin the more realistic shape of a parabolic
...
\item Continuation.  Determine the error in the calculated capacity of
...
\item Continuation.  Is it possible for the calculated capacity to be
...
\item The energy of a certain pendulum whose position is $x$ and
...
\item A frictionless pendulum conserves energy:
[[NOTE:The conservation  of energy leads to  a trade-off]]
...
conserve energy?
  ...
  \begin{enumerate}
  \item Approximately how much does $v$ change when $x$ decreases by
$\pi/180$?
...
\label{subsubsec:linear-approximations}


\begin{enumerate}
\item Write the linear approximation to $f(x, y) = \sin{x} \cos{y}$ at
the point $(x, y) = (0, \pi/2)$.

  \begin{enumerate}
  \item Write the equation of the tangent plane to the graph of $f(x, y)$
at the point $(x, y) = (0, \pi/2)$.

  \item Where does the tangent plane in part (b) meet the $x, y$-plane?


\end{enumerate}
\item Suppose $w(3, 4) = 2$ while
	\[
...
\item Write the equation of the tangent plane to the graph of the
function $\varphi(x, y) = 3 x^2 + 7 xy - 2 y^2 - 5x + 3 y$ at an
arbitrary point $(x, y) = (a, b)$.

  \begin{enumerate}
  \item At what point $(a, b)$ is the tangent plane horizontal?

  \item Magnify the graph of $\varphi$ at the point you found in part (b)
...
\end{enumerate}
\item Confirm that the system has an equilibrium point at $(R, F) =
(1000, 18)$.  Then obtain the phase portrait of the system near that
point.  What kind of equilibrium is there at $(1000, 18)$?


\item Obtain the linear approximations of the functions
\begin{align*}
...
\item Obtain the phase portrait of the {\bf linear} dynamical system
\begin{align*}
R' &= \ell_1(R, F),   \\
F' &= \ell_2(R, F).
\end{align*}
  ...
  \begin{enumerate}
  \item Does this system have an equilibrium at $(1000, 18)$?  Compare
...
\label{subsubsec:the-gradient-field}



\begin{enumerate}
\item Make a sketch of the gradient vector field of $f(x, y) = x^2 -
y^2$ on the domain $-2 \leq x \leq 2$, $-2 \leq y \leq 2$.

  \begin{enumerate}
  \item Mark on your sketch where the gradient field indicates the
maximum and the minimum values of $f$ are to be found in the domain.


\end{enumerate}
\item Repeat the previous exercise, using $f(x, y) = 2x + 4 x^2 - x^4 -
y^2$ and the domain $-2 \leq x \leq 2$, $-4 \leq y \leq 4$.  (See
exercises~5 and~6 in the previous section, page~\pageref{quartic}.)


\item Continuation.  Add to your sketch in the previous exercise a
...
\item Draw a plausible set of contour lines for the function whose
gradient vector field is plotted on the left below.


\item Draw a plausible gradient vector field for the function whose
contour plot is shown on the right below.  $H$ marks a local maximum
and $L$ a local minimum.

\noindent \includegraphics[width=\linewidth]{../ps/925/gradient.pdf}

\noindent \includegraphics[width=\linewidth]{../ps/925/contour2.pdf}
...
for {\em best}.)
[[NOTE:The contexts  for optimization]]     
...
\noindent \includegraphics[width=\linewidth]{../ps/931/OPT1.pdf}
...
[[NOTE:Extremes, and local extremes]]      
...
[[NOTE:The domain is  a constraint]]      
...
\noindent \includegraphics[width=\linewidth]{../ps/931/OPT2.pdf}

\noindent \includegraphics[width=\linewidth]{../ps/931/OPT3.pdf}

\noindent \includegraphics[width=\linewidth]{../ps/931/OPT4.pdf}
...
3$ to $x = 2.5$), 
[[NOTE:The maximum moves ---it even jumps]] 
...
[[NOTE:Catastrophes make the task of optimization more interesting.
  ...
  tools.  A good example is John Stuart Mill's
  ...
  a {\em paradigm shift\/} or an intellectual
  revolution.  The geological theory of plate tectonics is a familiar example.  Though proposed in the 1920s,
  it was dismissed until the 1960s, when it was suddenly and
  overwhelmingly accepted.]]

\noindent \includegraphics[width=\linewidth]{../ps/931/OPT5.pdf}

\noindent \includegraphics[width=\linewidth]{../ps/931/OPT6.pdf}

\noindent \includegraphics[width=\linewidth]{../ps/931/OPT7.pdf}
...
[[NOTE:Constraints  reduce optimality]]     
...
[[NOTE:Extremes  on the interior  of a density plot]]        
...
\noindent \includegraphics[width=\linewidth]{../ps/931/OPT10.pdf}

\noindent \includegraphics[width=\linewidth]{../ps/931/OPT11.pdf}

\noindent \includegraphics[width=\linewidth]{../ps/931/OPT12.pdf}

\noindent \includegraphics[width=\linewidth]{../ps/931/OPT13.pdf}

\noindent \includegraphics[width=\linewidth]{../ps/931/OPT14.pdf}
...
\noindent \includegraphics[width=\linewidth]{../ps/931/OPT15.pdf}

\noindent \includegraphics[width=\linewidth]{../ps/931/OPT16.pdf}

\noindent \includegraphics[width=\linewidth]{../ps/931/OPT17.pdf}
...
[[NOTE:An extreme can occur  where a contour  is tangent to  the boundary]]
...
\noindent \includegraphics[width=\linewidth]{../ps/932/opt18.pdf}

\noindent \includegraphics[width=\linewidth]{../ps/932/opt19.pdf}

\noindent \includegraphics[width=\linewidth]{../ps/932/opt20.pdf}
...
[[NOTE:Contour patterns  at an extreme]]    
...
\noindent \includegraphics[width=\linewidth]{../ps/932/opt21.pdf}

\noindent \includegraphics[width=\linewidth]{../ps/932/opt22.pdf}
...
\label{subsec:dimension-reducing-constraints}
\index{constraint!dimension-reducing}

Constraints appear frequently in optimization problems.  
[[NOTE:How a constraint can reduce the dimension of a problem]]    
...
\noindent \includegraphics[width=\linewidth]{../ps/932/constr1.pdf}

\noindent \includegraphics[width=\linewidth]{../ps/932/constr2.pdf}



        There is a standard form 
        [[NOTE:A standard form]]   
...
\subsubsection{Example.}
Find the extreme values of $f(x, y) = x^2 + 8 x y + 3
...
\noindent \includegraphics[width=\linewidth]{../ps/932/constr3.pdf}


The $z$-levels are labelled around the right and the bottom edges of
the figure.
[[NOTE:Finding the highest and lowest levels on the constraint curve]]
...
[[NOTE:Locate points on the constraint circle with a single variable $t$]]
...
[[NOTE:$z$ becomes a  function of $t$]]
...
\noindent \includegraphics[width=\linewidth]{../ps/932/constr4.pdf}

\noindent \includegraphics[width=\linewidth]{../ps/932/constr5.pdf}

\noindent \includegraphics[width=\linewidth]{../ps/933/wrap1.pdf}
...
\noindent \includegraphics[width=\linewidth]{../ps/933/wrap2.pdf}

\noindent \includegraphics[width=\linewidth]{../ps/933/wrap3.pdf}

\noindent \includegraphics[width=\linewidth]{../ps/933/wrap5.pdf}

\noindent \includegraphics[width=\linewidth]{../ps/933/wrap6.pdf}

\noindent \includegraphics[width=\linewidth]{../ps/933/wrap7.pdf}



\enlargethispage*{20pt}
The example shows us how a constraint works 
[[NOTE:A general view of the dimension-reducing effect of a constraint]]   
...
\noindent \includegraphics[width=\linewidth]{../ps/933/wrap9.pdf}

\noindent \includegraphics[width=\linewidth]{../ps/933/wrap10.pdf}

\noindent \includegraphics[width=\linewidth]{../ps/933/wrap11.pdf}
...
\label{subsec:extremes-and-critical-points}
\index{extreme}
\index{critical point}

\noindent \includegraphics[width=\linewidth]{../ps/933/sample.pdf}
...
[[NOTE:Moving to  an arbitrary number  of input variables]]  
...
[[NOTE:A statement and  its  converse]]
...
extreme point.
[[NOTE:The converse of {\em this\/} theorem is not true]]
...
[[NOTE:Searching  critical points  for extremes]]    
...
\noindent$\bullet$ Search for the extremes of a function among its critical points.

\noindent$\bullet$ A critical point may be neither a maximum nor a minimum.
...
\noindent \includegraphics[width=\linewidth]{../ps/934/contour1.pdf}
...
\subsubsection{[[EX:2]].}
Here is a somewhat more complicated function:
        \[
...
\noindent \includegraphics[width=\linewidth]{../ps/933/locus1.pdf}
...
[[NOTE:We first identified the local maximum of the function $z = x^3
...
\subsubsection{[[EX:3]].}
Here is a function whose critical points we {\em
...
\noindent \includegraphics[width=\linewidth]{../ps/934/contour3.pdf}

\noindent \includegraphics[width=\linewidth]{../ps/934/contour4.pdf}
...
\noindent \includegraphics[width=\linewidth]{../ps/934/contour5.pdf}

\noindent \includegraphics[width=\linewidth]{../ps/934/contour6.pdf}

\noindent \includegraphics[width=\linewidth]{../ps/934/contour7.pdf}



\subsection{The Method of Steepest Ascent}
\label{subsec:the-method-of-steepest-ascent}
\index{steepest ascent!method of}
\index{method of steepest ascent}

Here is yet another way to find the maximum\index{maximum}  
[[NOTE:Walk uphill to get  to a maximum]]   
...
[[NOTE:Trajectories of the gradient dynamical system\ldots]]       
...
[[NOTE:\ldots lead to  the local maxima]]
...
\subsubsection{[[EX:1]].}
Let's see how the method of steepest ascent will
find the local maxima of the function
        \[
z = h(x, y) = x^2 y^2 - x^4 - y^4 - 2x^2 + 5 xy + y
\]

\noindent \includegraphics[width=\linewidth]{../ps/934/ascent1.pdf}
...
[[NOTE:The method of steepest {\em descent}]]      
...
\noindent \includegraphics[width=\linewidth]{../ps/934/distrib1.pdf}


\subsubsection{[[EX:2]].}
Manufacturing companies ship their products to
...
[[NOTE:Minimize the  total distance]]       
...
\noindent \includegraphics[width=\linewidth]{../ps/934/descent1.pdf}

\noindent \includegraphics[width=\linewidth]{../ps/934/distrib2.pdf}
...
[[NOTE:The attractor is  a global minimum]] 
...
[[NOTE:The attractor is the limit point of a solution]] 
...
graph.
[[NOTE:The method needs only a differential equation solver]]      
...
[[NOTE:Equations for a constrained extreme]] we can use in the search for
...
\noindent \includegraphics[width=\linewidth]{../ps/934/lagr1.pdf}


Parallel vectors are multiples of each other.  
[[NOTE:The multiplier equation]]\index{multiplier equation}        
...
[[NOTE:Joseph Louis Lagrange (1736--1813) was a
  French mathematician and a younger contemporary of Leonhard
  Euler.  Like Euler he played an important role in
  ...
  mechanics, the field where Isaac
  Newton first applied the calculus.]]
...
[[NOTE:How can we find a constrained maximum or minimum?]] 
...
\subsubsection{Example.}
Find the maximum of $f(x, y) = x^p y^{1-p}$ subject to
...
\begin{enumerate}
\item Inspect the graph of $z = xy$ to find the maximum value of $z$
...
\item Inspect the graph of $z = 5 x + 2 y$ to find the minimum value of
...
\item Inspect a contour plot of $z = 3xy - y^2$ to find the maximum
...
\item Continuation.  Add the constraint $x \leq a$ to the preceding
...
\item Find the maximum and minimum values of $z = 12 x - 5 y$ when $(x,
y)$ is exactly 1~unit from the origin.


\item Find the maximum and minimum value
        [[NOTE:How is the gradient involved here?]]
of $z = px + qy$ when $(x, y)$ is exactly 1~unit from the origin.

  \begin{enumerate}
  \item At what point is the maximum achieved; at what point is the
minimum achieved?


\end{enumerate}
\item Use a graph to locate the maximum value of the function
        \[
...
\item Use a graph to find the maximum value of $z = 6x + 12 y - x^3 -
...
\item Locate the position of the minimum of $x^4 - 2 x^2 - \alpha x +
y^2$ as a function of the parameter $\alpha$.

  \begin{enumerate}
  \item The position of the minimum jumps catastrophically when $\alpha$
passes through a certain value.  At what value of $\alpha$ does this
happen, and what jump occurs in the minimum?


\end{enumerate}
\item Locate the maximum of $x^3 + y^3 - 3x - 3y$ subject to
        \[
...
$\beta$, which you can assume lies between 0 and 5.
  ...
  \begin{enumerate}
  \item The position of the maximum jumps catastrophically when $\beta$
crosses a certain threshold value $\beta_0$.  What is $\beta_0$?


\end{enumerate}
\item Find the maximum value of $x^2 y$ in the first quadrant, subject
to the constraint $x + 5 y = 10$.


\item Find the maximum and minimum values of $z = 3x + 4 y$ subject to
the single constraint $x^2 + 4xy + 5y^2 = 10$.


\item Find all the critical points of the following functions.

  \begin{enumerate}
  \item $3 x^2 + 7xy + 2 y^2 + 5x - 6 y + 3$.

  \item $\sin{x} \sin{y}$ \quad on the domain $-4 \leq x \leq 4$, $-4
\leq y \leq 4$.

  \item $\sin{xy}$ \quad on the domain $-4 \leq x \leq 4$, $-4 \leq y
\leq 4$.
  ...
  \item $x^3 - 3x y^2 - x^2 - y^2$.  [There are four critical points;
  three are saddles.]


\end{enumerate}
\item Find the nine critical points of the function
        \[
...
Four are minima, four are saddles, and one is a maximum.
  ...
  \begin{enumerate}
  \item Mark the locations of the critical points on a suitable contour
plot of $C(x, y)$.


\end{enumerate}
\item Locate and classify the critical points of the energy integral of
a pendulum:
        \[
E(x, v) = 1 - \cos{x} + \tfrac{1}{2}v^2.
\]
  ...
  \begin{enumerate}
  \item Compare the {\em critical points\/} of $E$ with the {\em
...
\end{enumerate}
\item Use the method of steepest descent to find the minimum of the function
        \[
...
\label{subsubsec:the-distribution-problem}
...
\begin{enumerate}
\item Suppose that one truck makes deliveries to $A$ 5 times each week,
...
\noindent$\bullet$ multiply the distance from $X$ to $A$ by 5;

\noindent$\bullet$ multiply the distance from $X$ to $B$ by 3;

\noindent$\bullet$ multiply the distance from $X$ to $C$ by 2.\\ 
...
\]
  ...
  \begin{enumerate}
  \item Use the method of steepest descent to find the minimum of $T$.

  \item Compare the location of the distribution center $X$ as determined
...
\end{enumerate}
\item Suppose that deliveries to $A$ are twice as frequent as
...
\item A company which has four offices around the country holds an
...
\label{subsubsec:the-best-fitting-line}
...
\noindent \includegraphics[width=\linewidth]{../ps/934/data1.pdf}
...
\noindent \includegraphics[width=\linewidth]{../ps/934/data2.pdf}
...
[[NOTE:The total errors are functions of $m$ and $b$]]
...
\begin{enumerate}
\item Inspect a graph and a contour plot to determine the values of $m$
...
\item Using a best-fitting line from the previous question, find the
predicted value of $y$ when $x = 5$.

  \begin{enumerate}
  \item Since there is a range of best-fitting lines, there should be a
range of predicted values for $y$ when $x = 5$.  What is that range?


\end{enumerate}
\item Write down the function $SE(m, b)$ that describes the squared
error in the fit of a straight line to the data given above.


\item Use a graph and a contour plot to locate the minimum of the
function $SE(m, b)$ from the previous exercise.  Indicate how many
digits of accuracy your answer has.


  \begin{enumerate}
  \item Use the method of steepest descent to locate the minimum.  How
