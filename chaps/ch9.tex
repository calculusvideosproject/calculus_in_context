...
\footnote{The problem of visualizing a function of several variables}	
...
\includegraphics{../ps/911/WEATHER1.pdf}
...
\footnote{Underground temperatures  fluctuate less}	
...
\includegraphics{../ps/911/WEATHER2.pdf}
\label{timegraph}
...
\footnote{The phase shifts  with the depth}
...
\footnote{Graphing temperature as a function of depth}	
...
\linebreak
\mbox{}
\includegraphics{../ps/911/WEATHER3.pdf}
\label{depthgraph}
below surface at the beginning of July. 
\footnote{Reading a  surface graph}
...
$A$ that we want.
\includegraphics{../ps/911/WEATHER5.pdf}
There is a definite connection between this surface and the two
collections of curves.
\footnote{Grid lines are slices of the surface that show how the function depends on each variable separately}	
...
surface are precisely these ``slice''\index{slice}\index{graph!slice
  of a} marks.
\includegraphics{../ps/911/WEATHER6.pdf}
...
\footnote{Comparing the surface to its slices}
...
\includegraphics{../ps/911/MINMAX1.pdf}
...
\index{minimum}
\includegraphics{../ps/911/MIN2.pdf}
...
\label{subsubsec:a-maximum-z--x2---y2}
\index{maximum}
\includegraphics{../ps/911/MAX2.pdf}
\begin{minipage}[t]{3.7in}
...
\index{minimax}
\includegraphics{../ps/911/SADDLE1.pdf}
\label{saddle}
\begin{minipage}[t]{3.7in}
...
\linebreak
\includegraphics{../ps/911/SADDLE2.pdf}
\includegraphics{../ps/911/SADDLE3.pdf}
\includegraphics{../ps/911/SADDLE4.pdf}
...
z)$.
\footnote{The points where $y = c$ form a vertical plane parallel to the $x, z$-plane}
...
\footnote{The points where $x = c$ form a vertical plane parallel to the
  $y, z$-plane}
...
\footnote{As you can see, it is valuable for you to be able to generate
...
\linebreak
\includegraphics{../ps/911/CUBIC1.pdf}
\includegraphics{../ps/911/CUBIC2.pdf}
a maximum.  
\footnote{The surface  has a saddle}
...
\includegraphics{../ps/911/CUBIC3.pdf}
\includegraphics{../ps/911/CUBIC4.pdf}
\includegraphics{../ps/911/CUBIC5.pdf}
The small figures on the right show the same surface as the large
\footnote{See the graph from different viewpoints}	
...
\includegraphics{../ps/911/PENDEN1.pdf}
\includegraphics{../ps/911/PENDEN2.pdf}
\begin{minipage}[t]{3.5in}
...
show up clearly.
\end{minipage}
\footnote{One way to describe what happens to a real pendulum---that is,
...
\includegraphics{../ps/912/DENSITY2.pdf}
\includegraphics{../ps/912/DENSITY1.pdf}
\begin{minipage}[t]{3.5in}
...
\includegraphics{../ps/912/DENSITY3.pdf}
\mbox{
	\small
	\mbox{} \hspace{25pt}
	$z = x^2 + y^2$
...
\]
\includegraphics{../ps/912/DENSITY4.pdf}
\includegraphics{../ps/912/density5.pdf}
...
saddles.
\footnote{These density plots show a ``checkerboard'' pattern because
...
\footnote{From densities  to contours}
...
direction.
\includegraphics{../ps/913/CONTOUR1.pdf}  
...
concentric ovals.
\footnote{Contours of the standard functions}
...
page~\pageref{saddle}.
\includegraphics{../ps/913/CONTOUR2.pdf}  
\includegraphics{../ps/913/CONTOUR3.pdf}  
\includegraphics{../ps/913/CONTOUR4.pdf}  
{\small
...
\footnote{Contours are  horizontal slices  of a graph}
...
\includegraphics{../ps/913/CONSURF1.pdf}
\includegraphics{../ps/913/CONSURF2.pdf}
\label{standard min max-end}
To get some more experience with contour plots, we return to 
\footnote{Energy of the pendulum, again}	
...
\includegraphics{../ps/913/contour5.pdf}
...
\footnote{Energy contours  are trajectories  of the dynamics}	
...
\includegraphics{../ps/913/contour6.pdf}
...
\label{subsec:technical-summary}
...
\includegraphics{../ps/914/SUMGRAPH.pdf}
\begin{minipage}[t]{3.3in}
...
\end{minipage} 
\includegraphics{../ps/914/SUMDENSE.pdf}
\includegraphics{../ps/914/SUMCON2.pdf}
\includegraphics{../ps/914/sumcon4.pdf}
\begin{minipage}[t]{3.7in}
...
\end{minipage}
\footnote{We find density plots everywhere.  A photograph is a density
...
\footnote{Plots are visually economical in comparison to graphs}	
...
value \linebreak
\includegraphics{../ps/915/XYZ1.pdf}
\begin{align*}
...
\footnote{The contours  are spheres}
...
\includegraphics{../ps/915/SHELLS1.pdf}
Below is the contour plot of another standard function 
\footnote{A standard minimax}	
...
page~\pageref{saddle}.)
\footnote{The contours  are hyperbolic shapes}	
...
\includegraphics{../ps/915/SHELLS2.pdf}
\includegraphics{../ps/915/SHELLS3.pdf}
It is a general fact---and our two examples 
\footnote{When there are three input variables, the contours are surfaces}	
...
\includegraphics{../ps/921/micro1.pdf}
\includegraphics{../ps/921/micro2.pdf}
\includegraphics{../ps/921/micro3.pdf}
...
\includegraphics{../ps/921/micro4.pdf}
...
A linear function 
\footnote{Responses to  changes in input}	
...
\footnote{Partial and  total changes}	
...
\footnote{Another way  to describe a  linear function}	
...
\footnote{From the definition  to a formula}	
...
\footnote{Given the partial  rates of change and  an initial point}
...
\footnote{Given the partial  rates of change and  the $z$-intercept}
...
\footnote{The form of  a linear function  of $n$ variables}	
...
\mbox{}
 \includegraphics{../ps/922/linear1.pdf}
 \includegraphics{../ps/922/linear2.pdf}
{\small
	\hspace{40pt}
	$z = - \tfrac{1}{2} x  + y + 4$
	\hspace{135pt}
...
\footnote{The definition of  a linear function  implies that its graph  is a
  flat plane}
...
\footnote{Each contour is  a straight line}	
...
r)/p$.)
\includegraphics{../ps/922/linear3.pdf}
\begin{minipage}[t]{3.5in}
...
\footnote{Partial rates and partial slopes}	
...
\includegraphics{../ps/922/linear4.pdf}
\includegraphics{../ps/922/linear5.pdf}
{\small
	\hspace{55pt}
	$z = -\tfrac{1}{2} x  + y + 4$
	\hspace{105pt}
...
not affected.  
\footnote{The overall tilt  of a graph is altered}
...
+4$).
\footnote{Partial rate and the spacing of contours} 	
...
$\Delta z/\Delta x$.
\includegraphics{../ps/922/linear6.pdf}
\includegraphics{../ps/922/linear7.pdf}
\includegraphics{../ps/922/linear8.pdf}
{\small
	\hspace{-3pt}
	$z = -\tfrac{1}{2} x  + y + 4
	\hspace{65pt}
...
\footnote{The larger  the partial rate,  the closer  the contours} 
...
\footnote{The vector of  partial rates}	
...
\footnote{The direction of  most rapid growth}	
...
\includegraphics{../ps/922/linear9.pdf}
\includegraphics{../ps/922/linear10.pdf}
\includegraphics{../ps/922/linear11.pdf}
Of course, the answer will depend on the linear function.  
\footnote{\hspace{-20pt} $z = -\tfrac{1}{2} x + y + 4$}		
...
\footnote{The magnitude of  most rapid growth}
...
page~\pageref{altdef})
	...
	$$
\includegraphics{../ps/922/linear12.pdf}
...
\footnote{Information from  the gradient}	
...
\footnote{End of the proof}
so we have confirmed that the length of the gradient is equal to the
maximum rate of increase.
\includegraphics{../ps/922/linear13.pdf}
\includegraphics{../ps/922/linear14.pdf}
\includegraphics{../ps/922/linear15.pdf}
{\small
	\hspace{20pt}
	$z = -\tfrac{1}{2} x  + y + 4$
	\hspace{65pt}
...
\footnote{Contour spacing and  the length  of the gradient}
...
\footnote{The gradient points directly uphill}	
...
\includegraphics{../ps/922/linear16.pdf}
...
two graphs help make it clear that $g$ is just a slice of~$f$\linebreak
 \includegraphics{../ps/922/linear18.pdf}
 \includegraphics{../ps/922/linear17.pdf}
{\small
\hspace{35pt}
$z = g(x) = x^{2/3}$
\hspace{85pt}
...
locally linear.
Functions that are
\footnote{The relation between calculus and fractals}	
...
\footnote{The equation of a microscopic view}	
...
\footnote{The microscope equation in the $x$-direction\ldots}	
...
\footnote{\ldots and in the $y$-direction}	
at $y = b$ is
	$$
...
\mbox{}
\includegraphics{../ps/921/micro5.pdf}
\includegraphics{../ps/921/micro6.pdf}
The separate microscope equations 
\footnote{From partial changes  to total change}	
...
\footnote{The microscope equation gives  a linear approximation}	
...
The
\footnote{Comparing the contours \ldots}
...
\includegraphics{../ps/922/micro7.pdf}
We can also compare 
\footnote{\ldots and the graph  of the function and its linear approximation} 
...
\mbox{}
\includegraphics{../ps/923/micro9.pdf}
\includegraphics{../ps/923/micro10.pdf}
...
\includegraphics{../ps/923/micro11.pdf}
\includegraphics{../ps/923/micro12.pdf}
There are many different ways 
\footnote{Elliptic points\ldots}
...
\mbox{} 
\includegraphics{../ps/923/micro9.pdf}
\includegraphics{../ps/923/micro13.pdf}
...
\footnote{\ldots and  hyperbolic points}	
...
finer.)
\footnote{The curve of intersection between a surface and a shifted
...
\footnote{The classification of the points into elliptical, parabolic,
...
\footnote{Consequences of  local linearity}	
...
\footnote{Extending the gradient to non-linear functions}
...
point to point.
\footnote{The gradient  vector field}
...
{\bf Example}.  \quad $f(x, y) = x^3 - 4x - y^2$, \quad
	\footnote{Contours and gradient vectors together} 
$\mbox{grad $f$} = (3x^2 - 4, -2y)$ 
\includegraphics{../ps/924/grad1.pdf}
\includegraphics{../ps/924/grad2.pdf}
There is one thing you should notice about the previous figure: 
\footnote{The vectors are rescaled for clarity}
...
\footnote{The relation between gradients and contours}	
...
\footnote{Visualizing a three-dimensional vector field}
...
\includegraphics{../ps/925/shells4.pdf}
\includegraphics{../ps/924/grad4.pdf}
{\small
\hspace{5pt}
$x^2 + y^2 - z^2 = c$
\hspace{125pt}
...
exercise.
\includegraphics{../ps/925/contour1.pdf}
  \begin{enumerate}
...
\includegraphics{../ps/925/linear1.pdf}
\includegraphics{../ps/925/linear2.pdf}
\end{enumerate}
...
\includegraphics{../ps/925/graph1.pdf}
\includegraphics{../ps/925/graph2.pdf}
\end{enumerate}
...
\footnote{The concept of   a {\em trade-off\/}}
...
the trade-off?
\footnote{The set in the last question is called a {\em trade-off
...
\item Continuation.
\footnote{Refer to the discussion of error propagation in chapter~3.4}
...
\includegraphics{../ps/925/cone.pdf}
...
\includegraphics{../ps/925/bowl.pdf}
...
\footnote{The conservation  of energy leads to  a trade-off}
...
\includegraphics{../ps/925/gradient.pdf}
\includegraphics{../ps/925/contour2.pdf}
\end{enumerate}
...
for {\em best}.)
\footnote{The contexts  for optimization}     
...
\footnote{Constrained optimization}  
...
\footnote{Mathematical optimization} 
...
\includegraphics{../ps/931/OPT1.pdf}
\begin{minipage}[t]{3.5in}
...
\footnote{Extremes, and local extremes}      
...
\footnote{The domain is  a constraint}      
...
\label{optimum1}% 
\linebreak
\includegraphics{../ps/931/OPT2.pdf}
\includegraphics{../ps/931/OPT3.pdf}
\includegraphics{../ps/931/OPT4.pdf}
...
3$ to $x = 2.5$), 
\footnote{The maximum moves ---it even jumps} 
...
\footnote{Catastrophes make the task of optimization more interesting.
...
\includegraphics{../ps/931/OPT5.pdf}
\includegraphics{../ps/931/OPT6.pdf}
\includegraphics{../ps/931/OPT7.pdf}
...
\end{minipage}
\includegraphics{../ps/931/OPT8.pdf}
\includegraphics{../ps/931/OPT9.pdf}
\begin{minipage}[t]{3.6in}
...
\footnote{Constraints  reduce optimality}     
...
\footnote{Extremes  on the interior  of a density plot}        
...
\includegraphics{../ps/931/OPT10.pdf}
\includegraphics{../ps/931/OPT11.pdf}
\includegraphics{../ps/931/OPT12.pdf}
\includegraphics{../ps/931/OPT13.pdf}
\includegraphics{../ps/931/OPT14.pdf}
...
\includegraphics{../ps/931/OPT15.pdf}
\includegraphics{../ps/931/OPT16.pdf}
\includegraphics{../ps/931/OPT17.pdf}
\begin{minipage}[t]{3.5in}
...
\footnote{An extreme can occur  where a contour  is tangent to  the boundary}
...
\includegraphics{../ps/932/opt18.pdf}
\includegraphics{../ps/932/opt19.pdf}
\includegraphics{../ps/932/opt20.pdf}
\begin{minipage}[t]{3.5in}
...
\footnote{Contour patterns  at an extreme}    
...
\linebreak
\includegraphics{../ps/932/opt21.pdf}
\includegraphics{../ps/932/opt22.pdf}
\begin{center}
...
\footnote{How a constraint can reduce the dimension of a problem}    
...
of the problem.
\includegraphics{../ps/932/constr1.pdf}
\includegraphics{../ps/932/constr2.pdf}
        There is a standard form 
        \footnote{A standard form}   
...
\footnote{A comment  on dimension}  
...
\includegraphics{../ps/932/constr3.pdf}
The $z$-levels are labelled around the right and the bottom edges of
the figure.
\footnote{Finding the highest and lowest levels on the constraint curve}
...
\footnote{Locate points on the constraint circle with a single variable $t$}
...
\footnote{$z$ becomes a  function of $t$}
...
\includegraphics{../ps/932/constr4.pdf}
\includegraphics{../ps/932/constr5.pdf}
\includegraphics{../ps/933/wrap1.pdf}
\begin{minipage}[t]{3.4in}
...
\includegraphics{../ps/933/wrap2.pdf}
\includegraphics{../ps/933/wrap3.pdf}
\includegraphics{../ps/933/wrap5.pdf}
\includegraphics{../ps/933/wrap6.pdf}
\includegraphics{../ps/933/wrap7.pdf}
\enlargethispage*{20pt}
The example shows us how a constraint works 
\footnote{A general view of the dimension-reducing effect of a constraint}   
...
\end{itemize}
\includegraphics{../ps/933/wrap9.pdf}
\includegraphics{../ps/933/wrap10.pdf}
\includegraphics{../ps/933/wrap11.pdf}
...
\includegraphics{../ps/933/sample.pdf}
\begin{minipage}[t]{3.6in}
...
\footnote{Moving to  an arbitrary number  of input variables}  
...
\footnote{A statement and  its  converse}
...
extreme point.
\footnote{The converse of {\em this\/} theorem is not true}
...
\footnote{Searching  critical points  for extremes}    
...
\end{align*}
\includegraphics{../ps/934/contour1.pdf}
\begin{minipage}[t]{3.5in}
...
equation ${\partial g/\partial x} = 0$ factors as
        ...
        $$
\includegraphics{../ps/933/locus1.pdf}
\begin{minipage}[t]{3.5in}
...
\includegraphics{../ps/934/contour2.pdf}
\begin{minipage}[t]{3.5in}
        $$
...
\end{minipage}
\footnote{We first identified the local maximum of the function $z = x^3
...
\includegraphics{../ps/934/contour3.pdf}
\includegraphics{../ps/934/contour4.pdf}
...
\end{minipage}
\includegraphics{../ps/934/contour5.pdf}
\includegraphics{../ps/934/contour6.pdf}
\includegraphics{../ps/934/contour7.pdf}
...
\footnote{Walk uphill to get  to a maximum}   
...
\footnote{Trajectories of the gradient dynamical system\ldots}       
...
\footnote{\ldots lead to  the local maxima}
...
find the local maxima of the function
        ...
        z = h(x, y) = x^2 y^2 - x^4 - y^4 - 2x^2 + 5 xy + y
        $$
\includegraphics{../ps/934/ascent1.pdf}
\begin{minipage}[t]{3.8in}
...
\footnote{The method of steepest {\em descent}}      
...
question.\index{steepest descent!method of}\index{method of steepest
  descent}
\includegraphics{../ps/934/distrib1.pdf}
...
\footnote{Minimize the  total distance}       
...
\end{align*}
\includegraphics{../ps/934/descent1.pdf}
\includegraphics{../ps/934/distrib2.pdf}
\mbox{}
As you can see from the vector field of the dynamical system 
\footnote{The attractor is  a global minimum} 
...
\footnote{The attractor is the limit point of a solution} 
...
graph.
\footnote{The method needs only a differential equation solver}      
...
\footnote{Equations for a constrained extreme} we can use in the search for
...
parallel.
\includegraphics{../ps/934/lagr1.pdf}
Parallel vectors are multiples of each other.  
\footnote{The multiplier equation}\index{multiplier equation}        
...
\footnote{Joseph Louis Lagrange\index{Lagrange, J. L.} (1736--1813) was a
...
\footnote{How can we find a constrained maximum or minimum?} 
...
\item Find the maximum and minimum value
        \footnote{How is the gradient involved here?}
...
\includegraphics{../ps/934/data1.pdf}
\mbox{}
\hspace{55pt}
\addtolength{\tabcolsep}{10pt}
        ...
        \end{tabular}
\addtolength{\tabcolsep}{-10pt}
\includegraphics{../ps/934/data2.pdf}
\begin{minipage}[t]{3.5in}
...
\footnote{The total errors are functions of $m$ and $b$}
