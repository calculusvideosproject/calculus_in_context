...
[[NOTE:Exponential solutions---with different bases~\ldots]]
...
suppressed by unnatural means).
  ...
  \begin{enumerate}
  \item Write differential equations for the size $P$ of a human
population and the size $F$ of the food supply that reflect Malthus'
assumptions about growth rates.

  \item Keep track of the population in millions, and measure the food
...
equations in (a).
  ...
  \item Use the formulas in (b) to calculate the amount of food and the
...
help you sketch graphs of $P=P(t)$ and $F=F(t)$ on the same axes.
  ...
  \item The per capita food supply in any year equals the ratio
...
[[NOTE:The accumulated change in $V$]]
...
\begin{enumerate}
\item Find a formula $y = F(t)$ for a solution to the differential
