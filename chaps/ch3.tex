...
\label{subsec:the-changing-time-of-sunrise}
\index{sunrise}

The sun rises at different times, 
[[NOTE:The time of sunrise  is a function]]
...
[[NOTE:Calculate the rate using earlier and  later dates]]
...
[[NOTE:Notice that, in each case, we have calculated the rate on a
...
the $S$-$I$-$R$ model.  
[[NOTE:Predictions over  long time spans  are less reliable]] 
...
\label{subsec:other-rates-other-units}
...
weight).  [[NOTE:Examples of rates]] Other common rates are the annual
...
[[NOTE:The rate of change  of a rate]]
...
\begin{enumerate}
\item What units do you use to measure velocity---that is, the rate of
change of distance with respect to time---in this problem?


\item Make a careful graph that shows these eight data points.  Put
      {\em time\/} on the horizontal axis.  Label the axes and
      indicate the units you are using on each.

  \begin{enumerate}
  \item The slope of any line drawn on this time--distance graph has the
units of a {\em velocity}.  Explain why.

\enlargethispage*{20pt}

\end{enumerate}
\item Make three estimates of the velocity of the falling object at the
...
\item Each of the estimates in the previous question corresponds to
the slope of a particular line you can draw in your graph.  Draw those
lines and label each with the corresponding velocity.

  \begin{enumerate}
  \item Which of the three estimates in the previous question do you
think is best?  Explain your choice.


\end{enumerate}
\item Using your best method, estimate the velocity of the falling
object after 4 seconds have passed.


\item Is the object speeding up or slowing down as it falls?  How can
you tell?


\item Approximate the velocity of the falling object after 7 seconds
...
\item For those of you attending a school at which you pay tuition,
find out what the tuition has been for each of the last four years at
your school.

  \begin{enumerate}
  \item At what rate has the tuition changed in each of the last three
years?  What are the units? In which year was the rate the greatest?

  \item A more informative rate is often the {\bf inflation
...
rates compare with the rates you found in part (a)?
  ...
  \item If you were interested in seeing how the inflation rate was
...
years?
  ...
  \item Using all this information, what would be your estimate for next
year's tuition?


\end{enumerate}
\item Your library should have several reference books giving annual
...
\item Oceanographers are very interested in the {\bf temperature
...
\noindent \includegraphics[width=\linewidth]{../ps/calc1/profile.pdf}
...
temperature settles to the bottom.)
  ...
  \begin{enumerate}
  \item What are the units for the rate of change of temperature with
depth?

  \item In this graph will the rate be positive or negative? Justify your
answer.

  \item At what rate is the temperature changing at a depth of 0 meters?
500 meters? 1000 meters?

  \item Sketch a possible temperature profile for this location if the
surface is iced over.

  \item This graph is not oriented the way our graphs have been up til
...
\label{sec:microscopes-and-local-linearity}
\index{microscope}
\index{local linearity}

\subsection{The Graph of Data}
\label{subsec:the-graph-of-data}
\index{graph!data}

\noindent \includegraphics[width=\linewidth]{../ps/calc1/sunrise1.pdf}
...
[[NOTE:Zoom in on the graph with a microscope]]
...
\noindent \includegraphics[width=\linewidth]{../ps/calc1/sunrise2a.pdf}
...
for each day of the year.  [[NOTE:The graph looks straight under a
...
$-1.5$ min/day, 
[[NOTE:Slope and  rate calculations  are the same]]
...
\label{subsec:the-graph-of-a-formula}
\index{graph!formula}
...
the space between the data points.  [[NOTE:High-power magnification is
...
\noindent \includegraphics[width=\linewidth]{../ps/calc1/mag1.pdf}

\noindent \includegraphics[width=\linewidth]{../ps/calc1/mag2.pdf}

\noindent \includegraphics[width=\linewidth]{../ps/calc1/mag3.pdf}

\noindent \includegraphics[width=\linewidth]{../ps/calc1/mag4.pdf}

\noindent \includegraphics[width=\linewidth]{../ps/calc1/mag5.pdf}

\noindent \includegraphics[width=\linewidth]{../ps/calc1/mag6.pdf}
...
[[NOTE:The field of view  of a window]]
...
[[NOTE:The microscope used to study functions is real, but it is
...
We should treat the values of $\Delta y/\Delta x$ as [[NOTE:The slope is
...
\label{subsec:local-linearity}
\index{local linearity}

The crucial property of a microscope\index{microscope}
[[NOTE:A microscope gives  a local view]]
...
[[NOTE:All the standard functions are  locally linear at  almost all points]]
...
\noindent \includegraphics[width=\linewidth]{../ps/calc1/cusp1.pdf}
...
\noindent \includegraphics[width=\linewidth]{../ps/calc1/cusp2.pdf}
...
\noindent \includegraphics[width=\linewidth]{../ps/calc1/cusp3.pdf}
...
fail to be locally linear anywhere!  Such functions are called {\bf
  fractals}.\index{fractal} [[NOTE:Fractals are locally {\em
...
\label{subsubsec:using-a-microscope}
\index{microscope}
...
\begin{enumerate}
\item Use a computer microscope to do the following.  (A suggestion:
first look at each graph over a fairly large interval.)


  \begin{enumerate}
  \item With a window of size $\Delta x = .002$, estimate the rate
$f'(1)$ where $f(x) = x^4 - 8x$.

  \item With a window of size $\Delta x = .0002$, estimate the rate
$g'(0)$ where $g(x) = 10^x$.

  \item With a window of size $\Delta t = .05$, estimate the slope of the
graph of $y = t + 2^{-t}$ at $t = 7$.

  \item With a window of size $\Delta z = .0004$, estimate the slope of
the graph of $w = \sin{z}$ at $z = 0$.



\end{enumerate}
\item Use a computer microscope to determine the following values,
...
each sequence.
  ...
  \begin{enumerate}
  \item $f'(1)$ where $f(x) = x^4 - 8x$.

  \item $h'(0)$ where $h(s) = 3^s$.

  \item The slope of the graph of $w = \sin{z}$ at $z = \pi/4$.

  \item The slope of the graph of $y = t + 2^{-t}$ at $t = 7$.

  \item The slope of the graph of $y = x^{2/3}$ at $x = -5$.



\end{enumerate}
\item For each of the following functions, magnify its graph at the
...
phosphor''!)
  ...
  \item $\varphi(t) = t + 2^{-t}$ at $t = 7$;


  \item $H(x) = x^{2/3}$ at $x = -5$.



\end{enumerate}
\item Consider the function that we investigated in the text:
	\[
f(x) = \dfrac{2 + x^3\cos{x} + 1.5^x}{2 + x^2}.
\]
  ...
  \item Make a sketch of the graph of $f$ on the interval $-1 \leq x \leq
1$.  Use the same scale on the horizontal and vertical axes so your
graph shows slopes accurately.

  \item Sketch what happens when you magnify the previous graph so the
field of view is only $-.001 \leq x \leq .001$.

  \item Estimate the slope of the line you drew in the part (c).

  \item Estimate $f'(0)$.  How many decimal places of accuracy does your
estimate have?

  \item What is the equation of the line in part (c)?



\end{enumerate}
\item A function that occurs in several different contexts in physical
problems is
	\[
g(x) = \frac{\sin{x}}{x}.
\]
Use a graphing program to answer the following questions.
  ...
  \begin{enumerate}
  \item Estimate the rate of change of $g$ at the following points to two
...
\]
  ...
  \item Find three values of $x$ where $g'(x) = 0$.

  \item In the interval from 0 to 2$\pi$, where is $g$ decreasing the
most rapidly?  At what rate is it decreasing there?

  \item Find a value of $x$ for which $g'(x)$ = -- 0.25.

  \item Although $g(0)$ is not defined, the function $g(x)$ seems to
behave nicely in a neighborhood of 0.  What seems to be true about
$g(x)$ and $g'(x)$ when $x$ is near 0?

  \item According to your graphs, what value does $g(x)$ approach as $x
...
\label{subsubsec:rates-from-graphs-graphs-from-rates}
...
\begin{enumerate}
\item \stepcounter{exercisepart}\alph{exercisepart})\enskip Sketch the
graph of a function $f$ that has $f(1) =1$ and $f'(1)~=~2$.

  \begin{enumerate}
  \item Sketch the graph of a function $f$ that has $f(1) =1$, $f'(1) =
2$, and $f(1.1) = -5$.



\end{enumerate}
\item A and B start off at the same time, run to a point 50 feet away,
...
where each runner is during this time interval.
  ...
  \begin{enumerate}
  \item Who is in the lead during the race?

  \item At what time(s) is A farthest ahead of B?  At what time(s) is B
farthest ahead of A?

  \item Estimate how fast A and B are going after one second.

  \item Estimate the velocities of A and B during each of the ten
...
that the graph of B's distance {\em is\/} locally linear at $t = 5$.)
  ...
  \item Use your graphs in (d) to answer the following questions.  When
...
\noindent \includegraphics[width=\linewidth]{../ps/calc1/prob114.pdf}


\end{enumerate}
\item For each of the following functions draw a graph that reflects
...
units in which any rate of change is expressed.
  ...
  \begin{enumerate}
  \item A woman's height $h$ (in inches) depends on her age $t$ (in
...
the spinal column.
  ...
  \item The number $R$ of rabbits in a meadow varies with time $t$ (in
...
quite as low as its value the previous year.
  ...
  \item In a fixed population of couples who use a contraceptive, the
...
\end{enumerate}
\item If we graph the distance travelled by a parachutist in
...
\noindent \includegraphics[width=\linewidth]{../ps/calc1/prob115.pdf}


  \begin{enumerate}
  \item Use this graph to make estimates of the parachutist's velocity at
the end of each second.

  \item Describe what happens to the velocity as time passes.

  \item How far do you think the parachutist would have fallen by the end
of 15 seconds?



\end{enumerate}
\item True or false.  If you think a statement is true, give your
reason; if you think a statement is false, give a
counterexample---i.e., an example that shows why it must be false.

  \begin{enumerate}
  \item If $g'(t)$ is positive for all $t$, we can conclude that $g(214)$
is positive.

  \item If $g'(t)$ is positive for all $t$, we can conclude that $g(214)
>g(17)\/$.

  \item Bill and Samantha are driving separate cars in the same direction
...
\label{subsubsec:when-local-linearity-fails}
\index{local linearity}
...
\begin{enumerate}
\item The absolute value function $f(x) = |x|$ is {\em not\/} locally
...
\item Find three points where the function $f(x) = |\cos{x}|$ fails to
be locally linear.  Sketch the graph of $f$ to demonstrate what is
happening.



\item Zoom in on the graph of $y = x^{4/5}$ at $(0, 0)$.  In order to
...
\item Is the function $x^{4/5}$ locally linear at $x = 1$?  Explain
your answer.



\item This question concerns the function $K(x) = x^{10/9}$.

  \begin{enumerate}
  \item Sketch the graph of $K$ on the interval $-1 \leq x \leq 1$.
...
origin, or not?
  ...
  \item Magnify the graph of $K$ at the origin repeatedly, until the
...
see in the final window.
  ...
  \item After using the microscope do you change your opinion about the
...
\put(0,0){\framebox (360,60){\parbox{360pt}{%
...
\put(50,0){\vector(0,1){150}}
	% --- expanded input{a331.tex} from a331.tex ---
...
\put(114.5,79){\framebox(11,9){\parbox{11pt}{%
...
\begin{picture}(110,80)
	\put(0,0){\framebox(110,80){\parbox{110pt}{%
...
$\Delta x$ smaller than the spacing between the data points.  [[NOTE:A
...
[[NOTE:There are rules for finding derivatives]]
...
The derivative is a limit, and there
...
\label{subsec:language-and-notation}

\noindent$\bullet$ If $f$ has a derivative at $a$, we also say {\bf \boldmath
...
\noindent$\bullet$ Do {\em locally linear\/} and {\em differentiable\/} mean
...
is a matter of convention.  [[NOTE:Convention: if the graph of $f$ is
...
\noindent$\bullet$ Suppose $y = f(x)$ and the quantities $x$ and $y$ appear in
...
\noindent$\bullet$ There are several notations for the derivative.  You should
...
[[NOTE:The German philosopher Gottfried Wilhelm Leibniz (1646-1716)
...
\label{subsubsec:a-context-driving-time}
...
[[NOTE:Travel time  depends on speed]]
...
[[NOTE:How does travel time respond to  changes in speed?]]
how much does any \\
...
\begin{picture}(135,96)(0,-2)
	\put(0,0){\framebox(126,90){\parbox{126pt}{%
...
mph.
[[NOTE:The slope of the graph in the microscope window]]
...
[[NOTE:How travel time changes with speed]]
...
[[NOTE:$\Delta s$ and $\Delta T$ now have a special meaning]]
...
[[NOTE:$\Delta s$ and $\Delta T$ are coordinates in the
...
[[NOTE:Global vs. local descriptions]]\index{global}
...
\put(0,0){\vector(0,1){48}}
   % --- expanded input{a335} from a335.tex ---
...
\put(11,45){\makebox(0,0)[l]{\small 
		$T = \dfrac{400}{s}$}}
\put(45,4){\framebox(10,8){\parbox{10pt}{%
...
% TODO: picture environment (manual conversion needed)
		\begin{picture}(60,50)
		\put(0,0){\framebox(60,48){\parbox{60pt}{%
...
\label{subsubsec:local-linearity-and-multipliers}
\index{local linearity}
\index{multiplier}
...
[[NOTE:The microscope equation is the analytic form of local linearity]]
...
% TODO: picture environment (manual conversion needed)
	...
	\put(0,0){\framebox(90,70){\parbox{90pt}{%
...
\noindent \includegraphics[width=\linewidth]{../ps/calc1/micro1.pdf}
...
[[NOTE:The microscope equation is the recipe for building solutions to
  rate equations]]
...
\put(0,0){\framebox (360,90){\parbox{360pt}{%
\begin{tabular}{cc}
...
\label{subsubsec:computing-derivatives}
\index{derivative}
...
\begin{enumerate}
\item Sketch graphs of the following functions and use these graphs to
...
\item For each of the functions $f$ below, approximate its derivative
...
many decimal places of accuracy it has.  
  ...
  \item $f(x) = \sin(7x)$ at $x = 3$.

  \item $f(x) = x^3$ at $x = 200$.

  \item $f(x) = 2^x$ at $x = 5$.


\end{enumerate}
\item In a later section we will establish that the derivative of $f(x)
...
In this problem $a = 1$.
  ...
  \begin{enumerate}
  \item Construct a table that shows the values of $Q_1$ and $Q_2$ for
...
\end{verbatim}
  ...
  \item How many digits of $Q_1$ stabilize in this table?  How many
digits of $Q_2$?

  \item Which is a better estimator---$Q_1$ or $Q_2$?  To indicate how much better, give the value of $h$ for which the {\em better\/} estimator provides an estimate that is as close as the best estimate provided by the {\em poorer\/} estimator.


\end{enumerate}
\item Repeat all the steps of the last question for the function $f(x) = \sqrt{x}$ at $x = 9$.  The exact value of $f'(9)$ is 1/6.
...
Note that, in section~1, we estimated the rate of
...
\begin{enumerate}
\item At this point you will find it convenient to write a more general
...
\item Use one of the methods of problem \thederivexercise\ to estimate
...
\item In this problem we look again at the exponential function
$f(x)=2^x$ from the previous problem.

  \begin{enumerate}
  \item Use the rules for exponents to put the quotient
\[
\frac{f(a+ h) - f(a)}{h}
\]
...
\end{enumerate}
\item Apply all the steps of the previous question to the exponential
function $f(x) = b^x$ with an arbitrary base $b$.  Show that $f'(x) =
f'(0) \cdot b^x$.



\item For which values of $x$ is the absolute value function $y = |x|$
differentiable?

  \begin{enumerate}
  \item At each point where $y = |x|$ is differentiable, find the value
of the derivative.
...
\begin{enumerate}
\item Write the microscope equation for each of the following functions
...
\end{enumerate}
\item This question uses the microscope equation for $f(x) = 1/x$ at $x
= 2$ that you constructed in the previous question.

  \begin{enumerate}
  \item Draw the graph of what you would see in the microscope if the
field of view is .2 units wide.

  \item If we take $x = 2.05$, what is $\Delta x$ in the microscope
...
values; how far is the microscope estimate from the true value?
  ...
  \item What estimate does the microscope equation give for 1/2.02?  How
far is this from the true value?

  \item What estimate does the microscope equation give for 1/1.995?  How
far is this from the true value?



\end{enumerate}
\item This question concerns the travel time function $T = 400/s$
hours, discussed in the text.

  \begin{enumerate}
  \item How many hours does a 400-mile trip take at an average speed of
40 miles per hour?

  \item Find the microscope equation for $T$ when $s = 40$ miles per
hour.

  \item At what rate does the travel time decrease as speed increases
around 40 mph---in hours {\em per\/} mile per hour?

  \item According to the microscope equation, how much travel time is
saved by increasing the speed from 40 to 45 mph?

  \item According to the microscope equation based at 50 mph (as done in
the text), how much time is {\em lost\/} by decreasing the speed from
50 to 45 mph?

  \item The last two parts both predict the travel time when the speed is
45 mph.  Do they give the same result?


\end{enumerate}
\item Suppose $y = f(x)$ is a function for which $f(5) = 12$ and
$f'(5) = .4$.  Write the microscope equation for $f$ at $x = 5$.

  \begin{enumerate}
  \item Draw the graph of what you would see in the microscope.  Do you
need a formula for $f$ itself, in order to do this?

  \item If $x = 5.3$, what is $\Delta x$ in the microscope equation?
...
estimate does the microscope equation then give for $f(5.3)$?
  ...
  \item What estimates does the microscope equation give for the
...
\end{enumerate}
\item Suppose $z = g(t)$ is a function for which $g(-4) = 7$ and
$g'(-4) = 3.5$.  Write the microscope equation for $g$ at $t = -4$.

  \begin{enumerate}
  \item Draw the graph of what you see in the microscope.

  \item Estimate $g(-4.2)$ and $g(-3.75)$.

  \item For what value of $t$ near $-4$ would you estimate that $g(t) =
6$?  For what value of $t$ would you estimate $g(t) = 8.5$?



\end{enumerate}
\item If $f(a) = b$, $f'(a) = -3$ and if $k$ is small, which of the
...
\item If $f$ is differentiable at $a$, which of the following, for
...
\item Suppose a person has travelled $D$ feet in $t$ seconds.  Then
$D'(t)$ is the person's velocity at time $t$; $D'(t)$ has units of
feet per second.

  \begin{enumerate}
  \item Suppose $D(5)$ = 30 feet and $D'(5)$ = 5 feet/second.  Estimate
the following:
\[
...
\]
  ...
  \item If $D(2.8)$ = 22 feet, while $D(3.1)$ = 26 feet, what would you
estimate $D'(3)$ to be?
...
\item Fill in the blanks.
  ...
  \begin{enumerate}
  \item If $f(3) = 2$ and $f'(3) = 4$, a reasonable estimate of $f(3.2)$
is \rule[-3pt]{.3in}{.3pt}.

  \item If $g(7) = 6$ and $g'(7) = .3$, a reasonable estimate of $g(6.6)$
is \rule[-3pt]{.3in}{.3pt}.

  \item If $h(1.6) = 1$, $h'(1.6) = -5$, a reasonable estimate of
$h(\rule[-3pt]{.3in}{.3pt})$ is 0.

  \item If $F(2) = 0$, $F'(2) = .4$, a reasonable estimate of
$F(\rule[-3pt]{.3in}{.3pt})$ is .15.

  \item If $G(0) = 2$ and $G'(0) =$ \rule[-3pt]{.3in}{.3pt}, a reasonable
estimate of $G(.4)$ is 1.6.

  \item If $H(3) = -3$ and $H'(3) =$ \rule[-3pt]{.3in}{.3pt}, a
reasonable estimate of $H(2.9)$ is $-1$.



\end{enumerate}
\item In manufacturing processes the profit is usually a function of
...
P(n)$.
  ...
  \begin{enumerate}
  \item If $P(1000)$ = \$500 and $P'(1000)$ = \$2/unit, then
	\[
...
\]
  ...
  \item If $P(2000)$ = \$3000 and $P'(2000)$ = $-$\$5/unit, then
	\[
...
\]
  ...
  \item If $P(1234)$ = \$625 and $P(1238)$ = \$634, then what is an
estimate for $P'(1236)$?
...
\label{sec:estimation-and-error-analysis}

\subsection{Making Estimates}
\label{subsec:making-estimates}
\index{estimate}

\subsubsection{The Expanding House}
\label{subsubsec:the-expanding-house}
...
[[NOTE:How much does  a house expand  in the heat?]]
...
\label{subsubsec:estimates-versus-exact-values}
...
multiplication.
[[NOTE:Exact values can be harder to calculate than estimates.]]
...
\label{subsec:propagation-of-error}
\index{error}
\index{propagation of error}

\subsubsection{From Measurements to Calculations}
\label{subsubsec:from-measurements-to-calculations}
...
[[NOTE:How uncertain is  the calculated value  of the volume?]]
...
Thus, for example, 
[[NOTE:The microscope equation describes how errors propagate]]
...
\label{subsubsec:relative-error}
...
[[NOTE:Bigger numbers  have bigger errors]] 
...
[[NOTE:A watchmaker who measures the tiny objects that go into a watch
...
[[NOTE:Absolute and  relative error]]
...
[[NOTE:Percentage error  is relative error]]
...
\begin{enumerate}
\item Suppose you are going on a 110 mile trip.  Then the time $T$ it
...
sentence interpreting this number.
  ...
  \begin{enumerate}
  \item More generally, if you and a friend are driving separate cars on
...
\end{enumerate}
\item Suppose you have 600 square feet of plywood which you are going
to use to construct a cubical box.  Assuming there is no waste, what
will its volume be?

  \begin{enumerate}
  \item Find a general formula which expresses the volume $V$ of the box
as a function of the area $A$ of plywood available.

  \item Use a microscope to determine $V'(600)$, and express its
significance in an English sentence.

  \item Use this multiplier to estimate the additional amount of plywood
you would need to increase the volume of the box by 10 cubic feet.

  \item In the original problem, if you had to allow for wasting 10
square feet of plywood in the construction process, by how much would
this decrease the volume of the box?

  \item In the original problem, if you had to allow for wasting 2\% of
the plywood in the construction process, by what percentage would this
decrease the volume of the box?


\end{enumerate}
\item Let $R(s) = 1/s$.  You can use the fact that $R'(s) = - 1/s^2$,
...
\item Using the fact that the derivative of $f(x) = \sqrt{x}$ is $f'(x)
= 1/(2\sqrt{x})$, you can estimate the square roots of numbers that
are close to perfect squares.

  \begin{enumerate}
  \item For instance $f(4) =$ \rule[-3pt]{.5in}{.3pt} and $f'(4) =$
\rule[-3pt]{.5in}{.3pt}, so $\sqrt{4.3} \approx$
\rule[-3pt]{.5in}{.3pt}.

  \item Use the values of $f(4)$ and $f'(4)$ to approximate $\sqrt{5}$
and $\sqrt{3.6}$.

  \item Use the values of $f(100)$ and $f'(100)$to approximate
...
\label{subsubsec:error-analysis}
\index{error}
...
\begin{enumerate}
\item If you measure the side of a square to be 12.3 inches, with an
uncertainty of $\pm.05$ inch, what is your relative error?

  \begin{enumerate}
  \item What is the area of the square?  Write an error propagation
equation that will tell you how uncertain you should be about this
value.

  \item What is the relative error in your calculation of the area?

  \item If you wanted to calculate the area with an error of less than 1
...
\end{enumerate}
\item Suppose the side of a square measures $x$ meters, with a
...
(The derivative of $f(x) = x^2$ is $f'(x) = 2x$; see section~5.)
  ...
  \begin{enumerate}
  \item Write an equation that describes how the {\em relative\/} error
in length propagates to a {\em relative\/} error in area.



\end{enumerate}
\item You are trying to measure the height of a building by dropping a
...
\item You see a flash of lightning in the distance and note that the
...
for some constant $k\/$.
  ...
  \begin{enumerate}
  \item Use the information given here to determine the value of $k$.

  \item If your estimate of the temperature is off by 5 degrees, how far
...
\end{enumerate}
\item We can measure the distance to the moon by bouncing a laser beam
...
\label{sec:a-global-view}
\index{global}

\subsection{Derivative as Function}
\label{subsec:derivative-as-function}
\index{derivative}
...
[[NOTE:The derivative  is a function  in its own right]]\index{function!derivative}
...
\noindent \includegraphics[width=\linewidth]{../ps/calc1/iiprime.pdf}



To understand the connection between the graphs, keep in mind that the
derivative represents a slope.
[[NOTE:The height of $I'$  is the slope of $I$]]
...
\noindent \includegraphics[width=\linewidth]{../ps/calc1/funny.pdf}


Then we know that its derivative $L'$ must be 0 at points $a$, $b$,
$c$, and $d$; 
[[NOTE:Finding a derivative   ``by eye'']] 
...
\noindent \includegraphics[width=\linewidth]{../ps/calc1/funnyslope.pdf}
...
\noindent \includegraphics[width=\linewidth]{../ps/calc1/funny3.pdf}
...
\label{subsec:formulas-for-derivatives}
\index{derivative}
\index{formula}

\subsubsection{Basic Functions}
\label{subsubsec:basic-functions}
...
[[NOTE:Formulas are combinations of  basic functions]]
...
\end{tabular}
\end{center}
[[NOTE:Remember that the input to the trigonometric functions is
...
$f(x) = g(x) + h(x)$.
[[NOTE:The addition rule]]\index{addition rule}
...
[[NOTE:The constant multiple rule]]
...
\label{subsubsec:sketching-the-graph-of-the-derivative}
\index{graph}
\index{derivative}
...
\begin{enumerate}
\item Sketch the graphs of two different functions that have the same
...
\item Here are the graphs of four related functions: $s$, its
...
\noindent \includegraphics[width=\linewidth]{../ps/calc1/sinprob.pdf}


\item Suppose a function $y = g(x)$ satisfies $g(0) = 0$ and $0 \leq
...
\noindent \includegraphics[width=\linewidth]{../ps/calc1/shaded.pdf}


  \begin{enumerate}
  \item Suppose you learn that $g(1) = .5$ and $g(2) = 1$.  Draw the
smallest shaded region in which you can guarantee that the graph of
$g$ must lie.


\end{enumerate}
\item Suppose $h$ is differentiable over the interval $0 \leq x \leq
...
\item For each of the functions graphed below, sketch the graph of its
derivative.

\noindent \includegraphics[width=\linewidth]{../ps/calc1/qualsketch.pdf}
...
\label{subsubsec:differentiation}
\index{differentiation}



\begin{enumerate}
\item Find formulas for the derivatives of the following functions; that is, {\em differentiate\/} them.

  \begin{enumerate}
  \item $f(x) = 3x^7 - .3 x^4 + \pi x^3 - 17$


  \item $g(x) = \sqrt{3}\,\sqrt{x} + \dfrac{7}{x^5}$


  \item $h(w) = 2w^8 - \sin{w} + \dfrac{1}{3 w^2}$


  \item $R(u) = 4\cos{u} - 3\tan{u} + \sqrt[3]{u}$


  \item $V(s) = \sqrt[4]{16} - \sqrt[4]{s}$


  \item $F(z) = \sqrt{7} \cdot 2^z + (1/2)^z$


  \item $P(t) =  -\dfrac{a}{2} t^2 + v_0 t + d_0$  \ ($a$, $v_0$, and $d_0$ are constants)



\end{enumerate}
\item Use a computer graphing utility for this exercise.  Graph on the
...
\end{enumerate}
  ...
  \begin{enumerate}
  \item $f(x) = x^4$ on $-1 \leq x \leq 1$.

  \item $f(x) = x^{-1}$ on $1 \leq x \leq 8$.

  \item $f(x) = \sqrt{x}$ on $.25 \leq x \leq 9$.

  \item $f(x) = \sin{x}$ on $0 \leq x \leq 2\pi$.
...
\end{enumerate}
\item In each case below, find a function $f(x)$ whose derivative
$f'(x)$ is:
...
\end{enumerate}
\item What is the slope of the graph of $y = x - \sqrt{x}$ at $x = 4$?
At $x = 100$?  At $x = 10000$?


\item For which values of $x$ is the function $x - x^3$ increasing?

  \begin{enumerate}
  \item Where is the graph of $y = x - x^3$ rising most steeply?

  \item At what points is the graph of $y = x - x^3$ horizontal?

  \item Make a sketch of the graph of $y = x - x^3$ that reflects all
these results.



\end{enumerate}
\item Sketch the graph of the function $y = 2x + \dfrac{5}{x}$ on the
interval $.2 \leq x \leq 4$.

  \begin{enumerate}
  \item Where is the lowest point on that graph?  Give the value of the
$x$-coordinate {\em exactly}.  [Answer: $x = \sqrt{5/2}$.]


\end{enumerate}
\item What is the slope of the graph of $y = \sin{x} + \cos{x}$ at $x =
\pi/4$?



\item Write the microscope equation\index{microscope equation} for $y
= \sin{x}$ at $x = 0$.

  \begin{enumerate}
  \item Using the microscope equation, estimate the following values:
$\sin{.3}$, $\sin{.007}$, $\sin(-.02)$.  Check these values with a
calculator. (Remember to set your calculator to radian mode!)


\end{enumerate}
\item Write the microscope equation for $y = \tan{x}$ at $x = 0$.

  \begin{enumerate}
  \item Estimate the following values: $\tan{.007}$, $\tan{.3}$,
$\tan(-.02)$.  Check these values with a calculator.



\end{enumerate}
\item Write the microscope equation for $y = \sqrt{x}$ at $x = 3600$.

  \begin{enumerate}
  \item Use the microscope equation to estimate $\sqrt{3628}$ and
$\sqrt{3592}$.  How far are these estimates from the values given by a
calculator?


\end{enumerate}
\item If the radius of a spherical balloon is $r$ inches, its volume is
$\tfrac{4}{3}\pi r^3$ cubic inches.

  \begin{enumerate}
  \item At what rate does the volume increase, in cubic inches per inch,
when the radius is 4 inches?

  \item Write the microscope equation for the volume when $r = 4$ inches.

  \item When the radius is 4 inches, approximately how much does it
increase if the volume is increased by 50 cubic inches?

  \item Suppose someone is inflating the balloon at the rate of 10 cubic
...
\end{enumerate}
\item A ball is held motionless and then dropped from the top of a 200
...
200$ feet.
  ...
  \begin{enumerate}
  \item Find a formula for the velocity $v=f'(t)$ of the ball after $t$
seconds.  Check that your formula agrees with the given information
that the initial velocity of the ball is 0 feet/second.

  \item Draw graphs of both the velocity and the distance as functions of
...
sense after the ball hits the ground?)
  ...
  \item At what time does the ball hit the ground?  What is its velocity
then?



\end{enumerate}
\item A second ball is tossed straight up from the top of the same
...
-16t^2 + 10t + 200$ feet.
  ...
  \begin{enumerate}
  \item Find a formula for the velocity of the second ball.  Does the
...
time.  What time interval makes physical sense in this situation?
  ...
  \item Use your graph to answer the following questions.  During what
...
falling?  When does it reach the highest point of its flight?
  ...
  \item How high does the ball rise?



\end{enumerate}
\item What is the velocity formula for a third ball that is thrown
      {\em downward\/} from the top of the building with a velocity of
      40 feet per second?  Check that your formula gives the correct
      initial velocity.

  \begin{enumerate}
  \item What is the distance formula for the third ball?  Check that it
satisfies the initial condition (namely, that the ball starts at the
top of the building).

  \item When does this ball hit the ground?  How fast is it going then?



\end{enumerate}
\item A steel ball is rolling along a 20-inch long straight track so
...
distances mean it is to the left.)
  ...
  \begin{enumerate}
  \item Find a formula for the velocity of the ball after $t$ seconds.
...
the ball.
  ...
  \item How far from the midpoint of the track does the ball get?  How
can you tell?

  \item How fast is the ball going when it is at the midpoint of the
track?  Does it ever go faster than this?  How can you tell?



\end{enumerate}
\item A forester who wants to know the height of a tree walks 100 feet
from its base, sights to the top of the tree, and finds the resulting
angle to be 57 degrees.

  \begin{enumerate}
  \item What height does this give for the tree?

  \item If the measurement of the angle is certain only to 5 degrees,
...
\end{enumerate}
\item In the preceding problem, what percentage error in the height of
the tree is produced by a 1 degree error in measuring the angle?

  \begin{enumerate}
  \item What would the percentage error have been if the angle had been
75 degrees instead of 57 degrees?  40 degrees?

  \item If you can measure angles to within 1 degree accuracy and you
...
\label{subsec:combining-rates-of-change}
\index{rate of change}
...
\]
We can condense 
[[NOTE:How volume responds to changes in temperature]]
this to     
\[
\Delta V \approx 48 \ 
...
[[NOTE:Recall that Leibniz worked
...
\label{subsec:chains-and-the-chain-rule}
\index{chain}
...
We can sometimes use the chain rule without
...
\subsubsection{Chains, in general.}
The chain rule applies whenever the output
...
\label{subsec:using-the-chain-rule}
...
\subsubsection{[[EX:1]].}
Here is a problem first mentioned on
...
{\bf [[EX:3]]}.  $p = \sqrt{7t^3 + \sin^2{t}}$.  This presents several challenges.  First let's make a chain:
	\[
...
\begin{enumerate}
\item Use the chain rule to find $dy/dx$, when $y$ is given as a
function of $x$ in the following way.

  \begin{enumerate}
  \item $y = 5u - 3$, where $u = 4 - 7x$.

  \item $y = \sin{u}$, where $u = 4 - 7x$.

  \item $y = \tan{u}$, where $u = x^3$.

  \item $y = 10^u$, where $u = x^2$.

  \item $y = u^4$, where $u = x^3 + 5$.
...
\item Find the derivatives of the following functions.
  ...
  \item $G(w) = \sqrt{4w^2 + 1}$.

  \item $S(w) = \sqrt{(4w^2 + 1)^3}$.

  \item $R(x) = \dfrac{1}{1 - x}$.  (Hint: think of $\dfrac{1}{1-x}$ as
$(1-x)^{-1}$.)


  \item $D(z) = 3 \tan \left(\dfrac{1}{z}\right)$.

  \item $\dog(w) = \sin ^2 (w^3+1)$.
...
\end{enumerate}
\item If $h(x)= (f(x))^6$ where $f$ is some function satisfying
$f(93)=2$ and $f'(93)=-4$, what is $h'(93)$?


\item If $H(x)= F(x^2-4x+2)$ where $F$ is some function satisfying
$F'(2)=3$, what is $H'(4)$?



\item If $f(x) = (1 + x^2)^5$, what are the numerical values of $f'(0)$
and $f'(1)$?



\item If $h(t) = \cos(\sin{t})$, what are the numerical values of
$h'(0)$ and $h'(\pi)$?



\item If $f'(x) = g(x)$, which of the following defines a function
...
\item Let $f(t) = t^2 + 2t$ and $g(t) = 5t^3 - 3$.  Determine all of
the following: $f'(t)$, $g'(t)$, $g(f(t))$, $f(g(t))$, $g'(f(t))$,
$f'(g(t))$, $(f(g(t)))'$, $(g(f(t)))'$.



\item What is the derivative of $f(x) = 2^{-x^2}$?

  \begin{enumerate}
  \item Sketch the graphs of $f$ and its derivative on the interval $-2
\leq x \leq 2$.

  \item For what values(s) of $x$ is $f'(x) = 0$?  What is true about the
graph of $f$ at the corresponding points?

  \item Where does the graph of $f$ have positive slope, and where does
it have negative slope?



\end{enumerate}
\item With a graphing utility, find the point $x$ where the function
$y = 1/(3x^2 - 5x + 7)$ takes its maximum value.  Obtain the numerical
value of $x$ accurately to two decimal places.

  \begin{enumerate}
  \item Find the derivative of $y = 1/(3x^2 - 5x + 7)$, and determine
...
\ans{$y' = -(6x - 5)(3x^2 - 5x + 7)^{-2}$, and $y' = 0$ when $x =
  ...
  \item Using part (b), find the {\em exact\/} value of $x$ where $y =
1/(3x^2 - 5x + 7)$ takes its maximum value.

  \item At what point is the graph of $y = 1/(3x^2 - 5x + 7)$ rising most
steeply?  Describe how you determined the location of this point.



\end{enumerate}
\item Write the microscope equation for the function $y =
\sin{\sqrt{x}}$ at $x = 1$.
...
\end{enumerate}
\item Write the microscope equation for $w = \sqrt{1 + x}$ at $x = 0$.

  \begin{enumerate}
  \item Use the microscope equation to estimate the values of
...
\end{enumerate}
\item When the sides of a cube are 5 inches, its surface area is
...
\item Find a function $f(x)$ for which $f'(x) = 3x^2(5 + x^3)^{10}$.
...
\item Find a function $g(t)$ for which $g'(t) = t/\sqrt{1 + t^2}$.
...
[[NOTE:The time of sunrise depends on latitude as well as on the date]]
...
[[NOTE:A function of several variables has several rates of change]]
...
\label{subsec:partial-derivatives-as-multipliers}
\index{multiplier}
	...
	[[NOTE:The microscope equation for dates]]
	\[
...
\]
	...
	[[NOTE:The microscope equation for latitudes]]
	\[
...
{\bf The full microscope equation:} \\
...
\label{subsec:formulas-for-partial-derivatives}
\index{formula}
...
[[NOTE:To find a partial derivative, treat the other variable as a constant]]
...
\subsubsection{[[EX:1]].}
For $z = F(x,y) = 3x^2y + 5y^2 \sqrt{x}$, we have
\begin{align*}
...
\subsubsection{[[EX:2]].}
For $w = G(u,v) = 3 u^5 \sin{v}  - \cos{v} + u$, we have
\begin{align*}
...
\begin{picture}(350,185)(-25,0)
 \put(0,30){\framebox(220,130){\parbox{220pt}{%
area = $l \cdot w$
}}} % big box
\put(0,0){\framebox(220,30){\parbox{220pt}{%
area = $l \cdot \Delta w$
}}} % next big
...
\put(220,0){\framebox(20,30){\parbox{20pt}{%

}}}		% little box
\put(220,30){\framebox(20,130){\parbox{20pt}{%
...
Changes $\Delta l$ and $\Delta w$ in the dimensions produce a change
	[[NOTE:The full microscope equation for rectangular area]]
	\[
...
\begin{enumerate}
\item Use differentiation formulas to find the partial derivatives of
the following functions.
  ...
  \item $ 17 \dfrac{x^2}{y^3} - x^2 \sin{y} + \pi$.

  \item $\dfrac{uv}{5} + \dfrac{5}{uv}$.

  \item $ 2 \sqrt{x} \, \sqrt[3]{y} - 7 \cos{x}$.

  \item $x\tan{y}$.


\end{enumerate}
\item On March 7 in the Northern Hemisphere, the farther south you are
...
\item The volume $V$ of a given quantity of gas is a function of the
...
where $R$ is a constant.
  ...
  \begin{enumerate}
  \item Find formulas for the partial derivatives $V_T(T,P)$ and
$V_P(T,P)$


  \item For a particular quantity of an ideal gas called a {\em mole},
...
meter.\index{units}
  ...
  \item Suppose a mole of gas at 350 degrees Kelvin is under a pressure
...
\end{enumerate}
\item Write the formula for a linear function $F(x, y)$ with the
...
\item The purpose of this exercise is to verify the claims made in the
text for the linear function $z=F(x,y) = mx + ny + c\/$, where $m$,
$n$ and $c$ are constants.

  \begin{enumerate}
  \item Use the differentiation rules to find the partial derivatives of
$F$.

  \item Use the {\em definition\/} of the partial derivative $F_x(a,b)$
...
exactly equals $m$, no matter what $a$ and $b$ are.
  ...
  \item Compute the exact value of the change
\[
...
\end{enumerate}
\item Suppose $w=G(u,v) = {\displaystyle \frac{uv}{3+v}}$.

  \begin{enumerate}
  \item Approximate the value of the partial derivative $G_u(1,2)$ by
computing $\Delta w/\Delta u$ for $\Delta u = \pm .1$, $\pm .01$,
\ldots, $\pm .00001$.

  \item Approximate the value of $G_v(1,2)$ by computing $\Delta w/\Delta
v$ for $\Delta v = \pm .1$, $\pm .01$, \ldots, $\pm .00001$.

  \item Write the full microscope equation for $G(u, v)$ at $(u, v) = (1,
2)$.

  \item Use the full microscope equation to approximate $G(.8,2.1)$.  How
close is your approximation to the true value of $G(.8,2.1)$?



\end{enumerate}
\item A rectangular piece of land has been measured to be 51 feet by
2034 feet.  What is its area?

  \begin{enumerate}
  \item The narrow dimension has been measured with an accuracy of 4
...
\]
  ...
  \begin{enumerate}
  \item Estimate $f(4, 12)$, $f(3, 13)$, $f(4, 13)$,
$f(4, 10)$.

  \item When $x = 3$ and $y = 12$, how much does a 1\% increase in $x$
...
\end{enumerate}
\item Let $P(K, L)$ represent the monthly profit, in thousands of
...
\]
  ...
  \begin{enumerate}
  \item Estimate what happens to the monthly profit if monthly capital
expenses increase to \$24,000.

  \item Each typical person added to the work force increases the monthly
...
the rate positive or negative?
  ...
  \item Suppose managers respond to increased demand for the product by
...
angle to be 57 degrees.
  ...
  \item If the 100-foot measurement is certain only to 1 foot and the
...
180 degrees.)
  ...
  \item Which would be more effective: improving the accuracy of the
