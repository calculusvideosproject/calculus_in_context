...
[[NOTE:Many patterns  are periodic]]	
...
\label{sec:periodic-behavior}


\subsubsection{[[EX:1]]: Populations.}
In chapter 4 we studied several models
...
happens in nature?
[[NOTE:Predator and  prey populations  fluctuate periodically]]
...
\noindent \includegraphics[width=\linewidth]{../ps/calc2/lynx1.pdf}




\subsubsection{[[EX:2]]: The earth's orbit.}
The earth orbits the sun, 
[[NOTE:The position and the shape of the earth's orbit both fluctuate
  periodically]]
...
\subsubsection{[[EX:3]]: The climate.}
In 1941 the Serbian geophysicist
Milutin Milankovitch\index{Milankovitch, M.} 
[[NOTE:Fluctuations in the climate appear in the geological record]]
...
\noindent \includegraphics[width=\linewidth]{../ps/calc2/sunspot.pdf}




\subsubsection{[[EX:4]]: Sunspot cycles.}
...
[[NOTE:Data can have  both periodic and  random influences]]
...
\label{sec:period-frequency-and-the-circular-functions}
...
[[NOTE:Defining a  periodic function]]	
...
\noindent \includegraphics[width=\linewidth]{../ps/calc2/period1.pdf}
...
there is a positive or negative number $T$ for which
	$\displaystyle g(x + T) = g(x) \qquad \mbox{for all $x$}.$
...
[[NOTE:A periodic function  has many periods\ldots]]	
...
[[NOTE:\ldots but we call the smallest positive one  {\em the\/} period]]
...
[[NOTE:The frequency of  a cycle is the  reciprocal of its period]]	
...
\noindent \includegraphics[width=\linewidth]{../ps/calc2/period2.pdf}
...
second.
	...
	[[NOTE:The units for measuring frequency over time]]	
...
[[NOTE:Functions can be periodic over other units as well]]
...
[[NOTE:Why $\cos{t}$ and $\sin{t}$  are periodic]]	
...
\noindent \includegraphics[width=\linewidth]{../ps/calc2/sincos.pdf}

\noindent \includegraphics[width=\linewidth]{../ps/calc2/circle2.pdf}

The circular functions are constructed 
[[NOTE:Radian measure]]\index{radian}\index{radian measure}\index{angle}	
...
[[NOTE:Changing the frequency]]
with that of $y = \sin(4t)$, below.

\noindent \includegraphics[width=\linewidth]{../ps/calc2/sin4t.pdf}
...
[[NOTE:Constructing a  circular function with  a given frequency]]	
...
\noindent \includegraphics[width=\linewidth]{../ps/calc2/cos10pit.pdf}




We will denote the frequency by $\omega$,
	[[NOTE:Frequency $\omega$]]
...
[[NOTE:Amplitude]]	\index{amplitude}
...
\noindent \includegraphics[width=\linewidth]{../ps/calc2/ampli.pdf}




\subsubsection{Physical interpretations.}
Sounds are transmitted to our ears as
...
\label{subsubsec:circular-functions}




\begin{enumerate}
\item Choose $\omega$ so that the function $\cos(2 \pi \omega t)$ has
each of the following periods.

  \begin{enumerate}
  \item \ 1 \hfill   b) \ 5 \hfill   c) \ $2\pi$ \hfill   d) \ $\pi$ \hfill
	e) \ 1/3 \hfill   \mbox{}



\end{enumerate}
\item Determine the period and the frequency of the following functions.

  \begin{enumerate}
  \item $\sin(x)$, $\sin(2x)$, $\sin(x) + \sin(2x)$


  \item $\sin(2x)$, $\sin(3x)$, $\sin(2x) + \sin(3x)$


  \item $\sin(6x)$, $\sin(9x)$, $\sin(6x) + \sin(9x)$


\end{enumerate}
\item Suppose $a$ and $b$ are positive integers.  Describe how the
...
\item What are the amplitude and frequency of $g(x) = 5 \cos(3x)$?

  \begin{enumerate}
  \item What are the amplitude and frequency of $g'(x)$?


\end{enumerate}
\item Is the antiderivative $\dint_0^x 5 \cos(3t) \, dt$ periodic?

  \begin{enumerate}
  \item If so, what are its amplitude and frequency?


\end{enumerate}
\item Use the definition of the circular functions to explain why
\begin{alignat*}{2}
\sin(-t) &= -\sin(t), & \qquad  
...
\item What is the average value of the function $\sin(s)$ over the
interval $0 \leq s \leq \pi$?  (This is a half-period.)


  \begin{enumerate}
  \item What is the average value of $\sin(s)$ over $\pi/2 \leq s \leq
3\pi/2$?  (This is also a half-period.)


  \item What is the average value of $\sin(s)$ over $0 \leq s \leq 2\pi$?
(This is a full period.)


  \item Let $c$ be any number.  Find the average value of $\sin(s)$ over
the full period $c \leq s \leq c + 2\pi$.

  \item Your work should demonstrate that the average value of $\sin(s)$
...
\end{enumerate}
\item What is the period $T$ of $P(t) = A\sin(bt)$?

  \begin{enumerate}
  \item Let $c$ be any number.  Find the average value of $P(t)$ over the
full period $c \leq t \leq c + T$.  Does this value depend on the
choice of $c$?

  \item What is the average value of $P(t)$ over the half-period $0 \leq
t \leq T/2$?
...
\noindent \includegraphics[width=\linewidth]{../ps/calc2/phase1.pdf}
...
\begin{enumerate}
\item The functions $\sin(x)$ and $\cos(x)$ have the same amplitude and
...
\item The functions $\sin(x)$ and $-\sin(x)$ {\em also\/} differ only
...
\item What is the phase difference between $\sin(x)$ and $-\cos(x)$?


\item Graph $y = \sin(t)$ and $y = \sin(t - \pi/3)$ on the same plane.

  \begin{enumerate}
  \item What is the phase difference between these two functions?

  \item What is the phase shift between their graphs?



\end{enumerate}
\item Graph together on the same coordinate plane $y = \cos(t)$ and $y
= \cos(t + \pi/4)$.
...
\end{enumerate}
\item We know $y = \cos(t)$ has a maximum at the origin.  Determine the
...
\item Repeat the last two exercises for the pair of functions $y =
\cos(2t)$ and $\cos(2t + \pi/4)$.  Is the phase difference equal to
the phase shift in this case?


\item Verify that the graph of $y = A\sin(bt - \varphi)$ crosses the
...
\item At what point nearest the origin does the function $A\cos(bt -
\varphi)$ reach its maximum value?

  \begin{enumerate}
  \item Explain why this shows $A\cos(bt - \varphi)$ is ``phase-shifted''
by the amount $\varphi/b$ in relation to $A\cos(bt)$.



\end{enumerate}
\item Let $f(x) = \sin(x) - .7\cos(x)$. Using a graphing utility,
sketch the graph of $f(x)$.

  \begin{enumerate}
  \item The function $f(x)$ is periodic.  What is its period?  From your
graph, estimate its amplitude.

  \item In fact, $f(x)$ can be viewed as a ``phase-shifted'' sine
function:
	\[
f(x) = A\sin(bx - \varphi).
\]
...
\end{enumerate}
\item For each of the values $\varphi = 0$, $\pi/4$, $\pi/2$,
...
on the same coordinate plane.
  ...
  \begin{enumerate}
  \item For which graphs is the average value positive, for which is it
negative, and for which is it 0?  Estimate by eye.


\end{enumerate}
\item The purpose of this exercise is to determine the average value
	\[
...
\item Sketch the graph of the {\em average value function\/}
$F(\varphi)$ you found in the previous exercise.  Use the interval $0
\leq \varphi \leq \pi$.

  \begin{enumerate}
  \item In exercise 19 you estimated the value of $F(\varphi)$ for five
...
\end{enumerate}
\item Sketch the graph of $y = \cos(x)\sin(x - \varphi)$ for each of
...
\item Obtain a formula for the average value function
	\[
...
\leq \pi$.
  ...
  \begin{enumerate}
  \item Use your formula for $G(\varphi)$ to compute the average value of
...
\end{enumerate}
\item How large a phase difference $\varphi$ is needed to make the
...
\item Sketch the graphs of the following functions.
  ...
  \begin{enumerate}
  \item $y = 3\sin(2x - \pi/6) - 1$


  \item $y = 4\sin(2x - \pi) + 2$.
...
\end{enumerate}
\item The function whose graph is sketched at the right has the form
	\[
G(x) = A \sin(bx - \varphi) + C.
\]
Determine the values of $A$, $b$, $C$, and $\varphi$.

\noindent \includegraphics[width=\linewidth]{../ps/calc2/phase2.pdf}



\item Write equations for three different functions that all have
...
\label{subsubsec:derivatives-with-degrees}




\begin{enumerate}
\item In this exercise measure the angle $\theta$ in degrees.
Estimate the derivative of $\sin(\theta)$ at $\theta = 0^{\circ}$ by
calculating $\sin(\theta)/\theta$ for $\theta = 2^{\circ}$,
$1^{\circ}$, $.5^{\circ}$.

  \begin{enumerate}
  \item Estimate the derivative of $\sin(\theta)$ at $\theta =
60^{\circ}$ in a similar way.  Is $(\sin(30^{\circ}))' =
\cos(30^{\circ})$?


\end{enumerate}
\item Your calculations in the previous exercise should support the
claim that $(\sin(\theta))' = k\cos(\theta)$ for a particular value of
$k$, when $\theta$ is measured in degrees.  What is $k$,
approximately?

  \begin{enumerate}
  \item If $t$ is the radian measure of an angle, and if
...
\label{sec:differential-equations-with-periodic-mboxsolutions}
...
\label{subsec:oscillating-springs}
...
\noindent \includegraphics[width=\linewidth]{../ps/calc2/spring8.pdf}
...
\label{subsubsec:the-linear-spring}

The simplest assumption we can reasonably make
[[NOTE:A linear spring]]
...
[[NOTE:The solution with  fixed parameters]]	
...
\noindent \includegraphics[width=\linewidth]{../ps/calc2/spring1.pdf}
...
[[NOTE:The solution  for arbitrary  parameter values]]	
...
is satisfied.
	...
	[[NOTE:The formula {\em proves\/} the motion is periodic]]	
...
We can see the relation between the motion and the parameters in the graph 
	[[NOTE:Graph of the general linear oscillator]]
below (in which we take $a > 0$).

\noindent \includegraphics[width=\linewidth]{../ps/calc2/spring2.pdf}
...
\label{subsubsec:the-non-linear-spring}
...
\noindent \includegraphics[width=\linewidth]{../ps/calc2/spring3.pdf}	 
...
[[NOTE:A non-linear oscillator]]\index{oscillator!non-linear}
problem:
\begin{alignat*}{2}
x' &= v,                  &\qquad  x(0) &= a,   \\
...
[[NOTE:Comparing a hard spring to a linear spring]]
...
\noindent \includegraphics[width=\linewidth]{../ps/calc2/spring4.pdf}



The non-linear spring behaves 
[[NOTE:The effect of amplitude on acceleration]]	
...
\noindent \includegraphics[width=\linewidth]{../ps/calc2/spring5.pdf}
...
[[NOTE:Large-amplitude oscillations]]	
...
\noindent \includegraphics[width=\linewidth]{../ps/calc2/spring6.pdf}




As a consequence, 
[[NOTE:The frequency of a non-linear spring depends on  its amplitude]]
...
\noindent \includegraphics[width=\linewidth]{../ps/calc2/spring7.pdf}

There are other ways we might have modified 
	[[NOTE:Other non-linear springs]]	
...
\label{subsec:the-sine-and-cosine-revisited}
...
[[NOTE:A computable definition of the  sine and cosine]]	
...
\label{subsec:the-pendulum}

\noindent \includegraphics[width=\linewidth]{../ps/calc2/pend1.pdf}
...
\noindent \includegraphics[width=\linewidth]{../ps/calc2/pend2.pdf}
...
[[NOTE:Newton's laws  produce a model  of the pendulum]]	
...
[[NOTE:The pendulum is  a soft spring]]	
...
\noindent \includegraphics[width=\linewidth]{../ps/calc2/pend3.pdf}
...
[[NOTE:Small-amplitude oscillations]]	
...
\noindent \includegraphics[width=\linewidth]{../ps/calc2/pend4.pdf}	
...
\noindent \includegraphics[width=\linewidth]{../ps/calc2/pend5.pdf}

\noindent \includegraphics[width=\linewidth]{../ps/calc2/pend6.pdf}
...
[[NOTE:The pendulum balanced on end]]	
...
These two solutions are called \label{equilibrium}\index{equilibrium}

{\bf equilibrium}
[[NOTE:Stable and unstable equilibrium solutions]]
solutions (from the Latin {\em {\ae}qui-\/}, equal + {\em libra}, a
balance scale).  If the pendulum is disturbed from its rest position,
it tends to return to rest.  For this reason, rest is said to be a

{\bf stable}\index{equilibrium!stable} equilibrium.  Contrast what
happens if the pendulum is disturbed when it is balanced upright.
This is said to be an {\bf unstable}
equilibrium.\index{equilibrium!unstable} We will take a longer look at
equilibria in chapter 8.


\subsection{Predator--Prey Ecology}\index{ecology}\index{predator--prey model}
\label{subsec:predator--prey-ecology}

\enlargethispage*{20pt}
Many animal populations 
[[NOTE:Why do populations fluctuate?]]	
...
[[NOTE:A predator-free equilibrium \ldots]]	
...
\noindent \includegraphics[width=\linewidth]{../ps/calc2/may1.pdf}



In the other models of periodic behavior we have studied, 
[[NOTE:Solutions with various initial conditions \ldots]]	
...
\noindent \includegraphics[width=\linewidth]{../ps/calc2/may2.pdf}
...
cases.
[[NOTE:\ldots all have the  same amplitude  and frequency]]	
...
\label{subsec:proving-a-solution-is-periodic}

The graphs in the last ten pages provide strong evidence that 
[[NOTE:Can we {\em prove\/} that systems have periodic oscillations?]]
...
[[NOTE:It may seem that what we should do is develop more methods for
  ...
  representation ``in closed form'' (that
...
\label{subsubsec:the-pendulum---a-qualitative-approach}
...
\label{subsubsec:the-trade-off-between-speed-and-height}
...
[[NOTE:Are we back  where we started?]]	
...
[[NOTE:Changes in speed \ldots modified]]
...
In particular, we have thus shown that $B_2$ (the position of the pendulum after it's gone over and back) $= a$ (the position of the pendulum at the beginning).  Thus the value for $x$ and the value for $v$ are the same in stage 5 and in stage 1---the two stages are mathematically indistinguishable.
	[[NOTE:\ldots and that the oscillations are periodic]]
...
\label{subsubsec:linear-springs}
...
\begin{enumerate}
\item {\bf Pure impulse}.\index{impulse} Take $b = 5$ per second, as in
...
(In other words, you strike the weight with a hammer as it sits
  ...
  \begin{enumerate}
  \item Use the differential equation solver on a computer to solve the
initial value problem numerically and graph the result.

  \item From the graph, estimate the period and the amplitude of the
solution.

  \item Find a formula for this solution, using the graph as a guide.

  \item From the formula, determine the period and amplitude of the
solution.  Does the period depend the initial impulse $p$, or only on
the spring constant $b$?  Does the amplitude depend on $p$?


\end{enumerate}
\item {\bf Impulse and displacement}.  Take $a = 4$ cm and $b = 5$ per
...
impulse of $p = -20$ cm/sec.
  ...
  \begin{enumerate}
  \item Solve the initial value problem numerically and graph the result.
...
\end{enumerate}
\item Let $a$ and $b$ have the values they did in the last exercise,
...
\item Let $a$, $b$, and $p$ have arbitrary values.  The last two
...
\item {\bf Strength of the spring}.  Take two springs, and suppose the
...
\item {\bf Effect of the weight}.  Hang weights from two identical
...
high, or some other multiplier?
  ...
  \begin{enumerate}
  \item Do this experiment in your head.  Measure the frequency of the
...
weight oscillates at twice the frequency; what is {\em its\/} mass?
  ...
  \end{enumerate}
\end{enumerate}
\subsubsection{A reality check.}
Do your results in the last two exercises agree
with your intuitions about the way springs operate?


\begin{enumerate}
\item {\bf First integral}.\index{first integral} Show that $E =
...
does not change as $t$ varies.
  ...
  \begin{enumerate}
  \item What value does $E$ have in this problem?

  \item If $x$ is measured in cm and $t$ in sec, what are the units for
$E$?


\end{enumerate}
\item This exercise concerns the initial value problem in the previous
question.  When $x = 0$, what are the possible values that $v$ can
have?

  \begin{enumerate}
  \item At a moment when the weight on the spring is motionless, how far
is it from the rest position?


\end{enumerate}
\item You already know that initial value problem in exercise
...
\label{subsubsec:non-linear-springs}




\begin{enumerate}
\item Suppose the acceleration $v'$ of the weight on a hard spring
...
its frequency be?
  ...
  \begin{enumerate}
  \item How far must you pull the weight so that its frequency will be
double the frequency in part (a)?  (Assume $p = 0$ cm/sec, so there is
still no initial impulse.)


\end{enumerate}
\item Suppose the acceleration of the weight on a hard spring is given
by $v' = -16x - .1\,x^3$ cm/sec$^2$.  If the weight is oscillating
with very small amplitude, what is the frequency of the oscillation?


\item Suppose a weight on a spring accelerates according to the formula
	\[
...
This is a soft spring.  Explain why.  [Graph $v'$ as a function of $x$.]
  ...
  \begin{enumerate}
  \item If the initial amplitude of the weight is $a = 4$ cm, and there
is no initial impulse (so $p = 0$ cm/sec), what is the frequency of
the oscillation?

  \item Double the initial amplitude, making $a = 8$ cm but keeping $p =
0$ cm/sec.  What happens to the frequency?

  \item Suppose you make the initial amplitude $a = 100$ cm.  Now what
happens to the frequency?


\end{enumerate}
\item {\bf First integrals}.\index{first integral}\label{spring energy}
...
\item Suppose the acceleration on a non-linear spring is $v' = -16 x -
x^3$ cm/sec$^2$, and initially $x = 2$ cm and $v = 0$ cm/sec.

  \begin{enumerate}
  \item The first integral of the preceding exercise must have a fixed
value for this spring.  What is that value?

  \item How fast is the spring moving when it passes through the rest
position?

  \item Can the spring ever be more than 2 cm away from the rest
position?  Explain your answer.


\end{enumerate}
\item Construct a first integral for the initial value problem
\begin{alignat*}{2}
x' &= v,  		  &\qquad 	x(0) &= a, \\
...
\item \label{ln first int}  Show that the function
	\[
...
is a first integral for the soft spring in exercise \thesoftexercise.
  ...
  \begin{enumerate}
  \item If the initial amplitude is $a = 4$ cm and the initial velocity
is 0~cm/sec, what is the speed of the weight as it moves past the rest
position?

  \item Prove that the motion of this spring is periodic.


\end{enumerate}
\item Suppose the acceleration on a non-linear spring has the general
...
\begin{enumerate}
\item Take $a = 0$ and given the pendulum three different initial
...
\item What is the period of the motion if $p = 1$; if $p = 2$?


\item By experiment, find how large an initial impulse $p$ is needed to
...
\item Suppose the initial position is horizontal: $a = +\pi/2$.  If
...
threshold value.
  ...
  \begin{enumerate}
  \item Reverse the direction of the initial impulse: $p < 0$, and choose
$p$ so the pendulum spins.  What is the smallest $|p|$ that will cause
spinning?


\end{enumerate}
\item {\bf First integrals}.  Consider the initial value problem
...
(page~\pageref{equilibrium}).
  ...
  \begin{enumerate}
  \item Is $x(t) = 0$, $y(t) = 0$ an equilibrium solution?

  \item Here is yet another equilibrium solution:
	\[
...
\end{enumerate}
\item Use a computer differential equation solver to graph the
...
{\em unstable\/} (as described on page~\pageref{equilibrium}).
  ...
  \begin{enumerate}
  \item Change the initial conditions to
	\[
x(0) = 5, \qquad y(0) = 5,
\]
...
\end{enumerate}
\item Consider this scenario.  Imagine that the prey species $x$ is an
...
\item {\bf The Lotka--Volterra model}.\index{Lotka--Volterra model} We
...
\item Solve the Lotka--Volterra model with $x(0) = 10$ and $y(0) = 5$.
...
\item Show that $x(t) = 0$, $y(t) = 0$ is an equilibrium solution of
...
\item Show that $x(t) = 10$, $y(t) = 20$ is another equilibrium
...
\item This is a repeat of the biological pest control scenario you
...
\item {\bf First integrals}.\label{L-V first int} As remarkable as it
...
\item Prove that the solutions of the Lotka--Volterra equations are
periodic.

\end{enumerate}
\subsubsection{The van der Pol oscillator}
\label{subsubsec:the-van-der-pol-oscillator}
...
\begin{enumerate}
\item Take $A = 4$, $B = 1$.  Make a sketch of the solution whose
...
\item Obtain the solution whose initial values are $x(0) = 2$, $y(0) =
